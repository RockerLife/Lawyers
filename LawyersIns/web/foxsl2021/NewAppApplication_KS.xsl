...
<xsl:stylesheet version="1.1"
	   ...
	   <fo:block>
                  ...
                  <xsl:choose>
                      <xsl:when test="response/policy_freeform_01/data/CompanyKey= 1">
                           ...
                           <xsl:when test="response/policy_freeform_01/data/CompanyKey= 3">
		                        <fo:block text-align="left" font-size="8px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" color="grey">  ISMIE ALA-04-S001 KS (04012022) </fo:block>
		                      </xsl:when>                
                      <xsl:otherwise>
        ...
        <fo:flow flow-name="xsl-region-body" >
         ...
         <xsl:otherwise>
		  ...
		  <xsl:if test="response/firm_freeform_01/data/IsFirmHaveLawyersLiabilityInsurance != 'N' and (response/StatusDesc != 'Issued' or response/firm_freeform_01/data/IsFirmHaveLawyersLiabilityInsurance = 'Y')">
            ...
            <fo:table>
              ...
              <fo:table-body>
                <fo:table-row>
                  <fo:table-cell  padding-top="10px" >
                    <fo:block  font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                      6.&#160;&#160; a.&#160;&#160;Enter the percentage of revenue for each area below in the past fiscal year. Indicate percentages in whole numbers
                    </fo:block>
                  </fo:table-cell>
					</fo:table-row>
				<fo:table-row>
                  <fo:table-cell >
                    <fo:block  font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                     &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; next to the type of law the firm practices :
 ...
 <xsl:if test="response/isBeforeLitigation='Y'">
        ...
        <xsl:if test="response/isBeforeLitigation='N'">
          ...
          <fo:block   border="0.2pt solid black"  start-indent="16pt" background-color="LightGray" space-after="4mm">
            <fo:table margin-top="1mm">
              <fo:table-column column-width="2in" />
              <fo:table-column column-width="2in"  />
              <fo:table-column column-width="1.5in"  />
			...
			<fo:list-block>
				<fo:list-item >
                <fo:list-item-label>
                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">6.</fo:block>
                </fo:list-item-label>
            ...
            <fo:list-block provisional-distance-between-starts="0.8cm" provisional-label-separation="0.15cm">
                  ...
                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" >
                    <fo:table border="0.2pt solid white">
                      ...
                      <fo:table-body>
                        ...
                        <xsl:if test="response/firm_freeform_01/data/IsApplicantProvidesLegalServices != 'N' and (response/StatusDesc != 'Issued' or response/firm_freeform_01/data/IsApplicantProvidesLegalServices = 'Y')">
                        <fo:table-row>
                          <fo:table-cell>
              ...
              <fo:list-item>
                ...
                <fo:list-item-body start-indent="3mm">
                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">
				   ...
				   <xsl:if test="response/firm_freeform_01/data/IsFirmProvideInvestmentAdvice != 'N' and (response/StatusDesc != 'Issued' or response/firm_freeform_01/data/IsFirmProvideInvestmentAdvice = 'Y')"> 
                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="justify" margin-bottom="10px" start-indent="0.25in" >
             ...
             <fo:list-item>
                ...
                <fo:list-item-body start-indent="3mm">
                  ...
                  <xsl:if test="response/firm_freeform_01/data/IsFirmHaveClientInEntertainmentInd != 'N' and (response/StatusDesc != 'Issued' or response/firm_freeform_01/data/IsFirmHaveClientInEntertainmentInd = 'Y')">
                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm">
              ...
              <fo:list-item>
                ...
                <fo:list-item-body start-indent="3mm">
                  ...
                  <xsl:if test="response/firm_freeform_01/data/IsFirmProvidedLegalService != 'N' and (response/StatusDesc != 'Issued' or response/firm_freeform_01/data/IsFirmProvidedLegalService = 'Y')">
              ...
              <fo:list-item>
                ...
                <fo:list-item-body start-indent="3mm">
                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm">
				   ...
				   <xsl:if test="response/firm_freeform_01/data/isPolicyExcludeCoverage != 'N' and (response/StatusDesc != 'Issued' or response/firm_freeform_01/data/isPolicyExcludeCoverage = 'Y')">
                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm">
                    <fo:table >
                      <fo:table-column />
                      <fo:table-body>
            ...
            <fo:list-block provisional-distance-between-starts="0.8cm" provisional-label-separation="0.15cm">
              ...
              <fo:list-item>
                ...
                <fo:list-item-body start-indent="3mm">                  
                  ...
                  <xsl:if test="response/firm_freeform_01/data/IsAttorneyDeclineForProfLiability != 'N' and (response/StatusDesc != 'Issued' or response/firm_freeform_01/data/IsAttorneyDeclineForProfLiability = 'Y')">
                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm">
                    <fo:table border="0.2pt solid white">
...
<xsl:when test="response/policy_freeform_01/data/StateCode='IA'">	
  ...
  <!--  <fo:block break-after="page"/> -->
		...
		<xsl:if test="(response/firm_freeform_01/data/IsFirmCoverageForPreceedorFirms != 'N' and (response/StatusDesc != 'Issued' or response/firm_freeform_01/data/IsFirmCoverageForPreceedorFirms = 'Y')) or (response/firm_freeform_01/data/IsApplIntToFinanAssests != 'N' and (response/StatusDesc != 'Issued' or response/firm_freeform_01/data/IsApplIntToFinanAssests = 'Y'))">
...
<xsl:if test="(response/StatusDesc != 'Issued' and response/aop_total != 100) or response/AOP_PercentageValueCheck_3 > 35">
<fo:block page-break-after="always"></fo:block>
          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" padding-top="20px" padding-bottom="10px">
            <fo:table border="0.2pt solid black">
              <fo:table-column/>
...
<xsl:if test="(response/StatusDesc != 'Issued' and response/aop_total != 100) or response/AOP_PercentageValueCheck_31 > 0">
<fo:block page-break-after="always"></fo:block>
		...
		<xsl:if test="(response/StatusDesc != 'Issued' and response/aop_total != 100) or (response/AOP_PercentageValueCheck_6 > 0)"><!-- and(response/AOP_PercentageValueCheck_6 &lt;= 6)) -->
		<fo:block page-break-after="always"></fo:block>
          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" padding-top="20px" padding-bottom="10px" >
            <fo:table border="0.2pt solid black">
              <fo:table-column/>
...
<xsl:if test="(response/StatusDesc != 'Issued' and response/aop_total != 100) or response/AOP_PercentageValueCheck_8 > 35">
<fo:block page-break-after="always"></fo:block>
          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" padding-top="20px" padding-bottom="10px" >
            <fo:table border="0.2pt solid black">
              <fo:table-column/>
          ...
          <fo:block>
           ...
           <xsl:if test="(response/StatusDesc != 'Issued' and response/aop_total != 100) or response/AOP_PercentageValueCheck_12 > 0">
           <fo:block page-break-after="always"></fo:block>
          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" padding-top="20px" padding-bottom="10px">
            <fo:table border="0.2pt solid black">
              <fo:table-column/>
...
<xsl:if test="(response/StatusDesc != 'Issued' and response/aop_total != 100) or response/AOP_PercentageValueCheck_13 > 0"> 
<fo:block page-break-after="always"></fo:block>
          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" padding-top="20px" padding-bottom="10px">
            <fo:table border="0.2pt solid black">
              <fo:table-column/>
...
<xsl:if test="(response/StatusDesc != 'Issued' and response/aop_total != 100) or response/isShowLitigationSupplement = 'Y'">
<fo:block page-break-after="always"></fo:block>
...
<xsl:if test="(response/StatusDesc != 'Issued' and response/aop_total != 100) or response/FlagForRealEstate='Y'">
    <fo:block page-break-after="always"></fo:block>
          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" padding-top="20px" padding-bottom="10px">
            <fo:table border="0.2pt solid black">
              <fo:table-column/>
		...
		<xsl:if test="(response/StatusDesc != 'Issued' and response/aop_total != 100) or response/AOP_PercentageValueCheck_22 > 25">
		<fo:block page-break-after="always"></fo:block>
          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" padding-top="20px" padding-bottom="10px">
            <fo:table border="0.2pt solid black">
              <fo:table-column/>
...
<xsl:if test="(response/StatusDesc != 'Issued' and response/aop_total != 100) or response/AOP_PercentageValueCheck_24 > 0">
<fo:block page-break-after="always"></fo:block>
