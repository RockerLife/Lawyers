                      ...
                      <fo:table-body>
                        ...
                        <fo:table-row>
                         ...
                         <fo:table-row>
                          ...
                          <fo:table-cell  border="0.2pt solid black"  display-align="after">
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="center">
                           <xsl:value-of select="response/bankruptcyCasesDetails_new_list_04/data/Percentage"></xsl:value-of>%  &#160;
                            </fo:block>
                          </fo:table-cell>
                          <fo:table-cell  border="0.2pt solid black"  display-align="after">
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="center">
                            <xsl:value-of select="response/bankruptcyCasesDetails_new_list_04/data/AverageCaseValue"></xsl:value-of>  &#160;
                            </fo:block>
                          </fo:table-cell>
                         </fo:table-row>
