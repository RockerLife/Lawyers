                   ...
                   <xsl:if test="response/policy_freeform_01/data/CompanyKey= 1">
                    <xsl:choose>
                      <xsl:when test="response/policy_freeform_01/data/StateCode= 'FL'">
                        <fo:block text-align="left" font-size="8px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" color="grey">  LPL–131 (01/20) FL </fo:block>
                      </xsl:when>
                     <!--  <xsl:when test="response/policy_freeform_01/data/StateCode= 'CT'">
                      ...
                      <xsl:otherwise>
                        <fo:block text-align="left" font-size="8px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" color="grey"> LPL – 101 (01/21) MT</fo:block>
                      </xsl:otherwise>
                    </xsl:choose>
                    </xsl:if>
          ...
          <fo:block>
            <fo:table margin-top="3mm">
              ...
              <fo:table-body>
                ...
                <fo:table-row>
                  <fo:table-cell>
                    <fo:block  font-size="14px" font-family="Arial Black" font-weight="bold" text-align="center">LAWYERS PROFESSIONAL LIABILITY APPLICATION – MONTANA</fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-body>
            </fo:table>
          ...
          <fo:block>
            <fo:table margin-top="3mm" border="0.0pt solid black">
              ...
              <fo:table-body>
                <fo:table-row >
                  <fo:table-cell >
                    <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">NOTICE: COVERAGE FOR WHICH THIS APPLICATION IS MADE IS WRITTEN ON A CLAIMS MADE AND REPORTED BASIS MEANING, EXCEPT AS OTHERWISE PROVIDED, COVERAGE APPLIES ONLY TO <fo:inline font-weight="bold">CLAIMS</fo:inline> FIRST MADE AGAINST THE <fo:inline font-weight="bold">INSURED</fo:inline> AND REPORTED TO THE <fo:inline font-weight="bold">INSURER</fo:inline> DURING THE <fo:inline font-weight="bold">POLICY PERIOD</fo:inline> OR DURING ANY APPLICABLE EXTENDED REPORTING PERIOD. UNLESS YOU SELECT OTHERWISE, THE LIMIT OF LIABILITY AVAILABLE TO PAY <fo:inline font-weight="bold">DAMAGES</fo:inline> WILL BE REDUCED, AND MAY BE EXHAUSTED, BY <fo:inline font-weight="bold">DEFENSE EXPENSES</fo:inline>.</fo:block>
                  </fo:table-cell>
                </fo:table-row>
				 <fo:table-row >
                  <fo:table-cell >
                    ...
                    <fo:table border="0.2pt solid white">
                      ...
                      <fo:table-body>
                        <fo:table-row>
                          <fo:table-cell>
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="justify" space-after="4mm" margin-top="10px">
                              Within the past five years has the firm or its attorneys been declined, canceled, or non-renewed for professional liability insurance for any reason?
                            </fo:block>
                          </fo:table-cell>
                          <fo:table-cell text-align="right">
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" margin-top="10px">
