							...
							<xsl:when
								...
								<xsl:choose>
									...
									<xsl:when
										...
										<xsl:choose>
											<xsl:when
												test="response/policy_freeform_01/data/StateCode= 'FL'">
												<fo:block text-align="left" font-size="8px"
													font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;"
													color="grey"> LPL–101 (02/20) FL </fo:block>
											</xsl:when>
						
											<xsl:otherwise>
												<fo:block text-align="left" font-size="8px"
													font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;"
													color="grey"> LPL – 101 (01/21)</fo:block>
											</xsl:otherwise>
										</xsl:choose>
									</xsl:when>
									...
									<xsl:otherwise>
										<fo:block text-align="left" font-size="8px"
											font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;"
											color="grey"> Default</fo:block>
									</xsl:otherwise>
								</xsl:choose>
							</xsl:when>
							<xsl:when
								test="response/policy_freeform_01/data/CompanyKey= 3">
								<fo:block text-align="left" font-size="8px"
									font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;"
									color="grey"> ISMIE ALA-04-S001 (09/01/2021) </fo:block>
							</xsl:when>
							<xsl:otherwise>
								<fo:block text-align="left" font-size="8px"
									font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;"
          ...
          <fo:block>
            <fo:table margin-top="3mm">
              ...
              <fo:table-body>
                ...
                <fo:table-row>
                  <fo:table-cell>
                     <fo:block  font-size="14px" font-family="Arial Black" font-weight="bold" text-align="center">LAWYERS PROFESSIONAL LIABILITY APPLICATION - FLORIDA</fo:block>
                     </fo:table-cell>
                </fo:table-row>
              </fo:table-body>
            </fo:table>
