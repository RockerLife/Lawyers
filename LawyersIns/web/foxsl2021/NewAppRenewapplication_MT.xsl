      ...
      <fo:page-sequence master-reference="A4-portrait">
            ...
            <fo:table-body>
              <fo:table-row>
				...
				<xsl:when test="response/policy_freeform_01/data/StateCode= 'FL'">
					<fo:block text-align="left" font-size="8px" font-family="Arial" color="grey">  LPL – 101 (02/20) FL</fo:block>	
				</xsl:when>
				<!-- <xsl:when test="response/policy_freeform_01/data/StateCode= 'CT'">
					<fo:block text-align="left" font-size="8px" font-family="Arial" color="grey">  LPL CT - 131 (08-13)</fo:block>	
				</xsl:when> -->
				<xsl:when test="response/policy_freeform_01/data/StateCode= 'NH'">
					<fo:block text-align="left" font-size="8px" font-family="Arial" color="grey">  LPL – NH - 101 (01/20)</fo:block>	
				</xsl:when>
				<xsl:when test="response/policy_freeform_01/data/StateCode= 'IA'">
					<fo:block text-align="left" font-size="8px" font-family="Arial" color="grey">  LPL – IA - 101 (01/20)</fo:block>	
				</xsl:when>
				<xsl:otherwise>
					<fo:block text-align="left" font-size="8px" font-family="Arial" color="grey"> LPL – 131 (01/21) MT</fo:block>	
				</xsl:otherwise>
				</xsl:choose>
				</xsl:if>
        ...
        <fo:flow flow-name="xsl-region-body">
          ...
          <fo:block  font-size="14px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" font-weight="bold" text-align="center" space-after="4mm">
            LAWYERS PROFESSIONAL LIABILITY RENEWAL APPLICATION – MONTANA
          </fo:block>

          <fo:block  font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="justify"  space-after="4mm">
            NOTICE: COVERAGE FOR WHICH THIS APPLICATION IS MADE IS WRITTEN ON A CLAIMS MADE AND REPORTED BASIS MEANING, EXCEPT AS OTHERWISE PROVIDED, COVERAGE APPLIES ONLY TO <fo:inline> CLAIMS </fo:inline> FIRST MADE AGAINST THE <fo:inline font-weight="bold"> INSURED </fo:inline> AND REPORTED TO THE <fo:inline font-weight="bold"> INSURER </fo:inline> DURING THE <fo:inline font-weight="bold">POLICY PERIOD</fo:inline> OR DURING ANY APPLICABLE EXTENDED REPORTING PERIOD. UNLESS YOU SELECT OTHERWISE, THE LIMIT OF LIABILITY AVAILABLE TO PAY <fo:inline font-weight="bold">DAMAGES</fo:inline> WILL BE REDUCED, AND MAY BE EXHAUSTED, BY <fo:inline font-weight="bold">DEFENSE EXPENSES</fo:inline>.</fo:block>
          <fo:block  font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="justify"  space-after="4mm">
