...
<xsl:stylesheet version="1.1"
	...
	xmlns:java="java">
      ...
      <xsl:include  href="foxslnew/group1/LPL - AMEND - GA.xsl" />
      <xsl:include  href="foxslnew/group1/LPL - AMEND - IL.xsl" />
      <xsl:include  href="foxslnew/group1/LPL - AMEND - IN.xsl" />
      <xsl:include  href="foxslnew/group1/LPL - AMEND - MO.xsl" />
      <xsl:include  href="foxslnew/group1/LPL - AMEND - NJ.xsl" />
      <xsl:include  href="foxslnew/group1/LPL - AMEND - NM.xsl" />
      <xsl:include  href="foxslnew/group1/LPL - AMEND - TN .xsl" />      
      <xsl:include  href="foxslnew/group1/LPL - AMEND - KY.xsl" />      
      <xsl:include  href="foxslnew/group1/LPL - AMEND - WI.xsl" />
      
      <xsl:include  href="foxslnew/group1/LPL - KY - TAX.xsl" />
      <xsl:include  href="foxslnew/group1/MA - LPL - 102.xsl" />
      <xsl:include  href="foxslnew/group1/MA - LPL - 103.xsl" />
      <xsl:include  href="foxslnew/group1/MA - LPL - 104.xsl" />
      <xsl:include  href="foxslnew/group1/LPL - AMEND - NJ  2013.xsl" /> 
      <xsl:include  href="foxslnew/group1/FM303-0-26-02-14.xsl" />     
      
      <!-- Group 2 States -->
      <xsl:include  href="foxslnew/group2/LPL - AMEND - AK.xsl" />
      <xsl:include  href="foxslnew/group2/LPL - AMEND - HI.xsl" />
      <xsl:include  href="foxslnew/group2/LPL - AMEND - IA.xsl" />
      <xsl:include  href="foxslnew/group2/LPL - AMEND - KS.xsl" />
      <xsl:include  href="foxslnew/group2/LPL - AMEND - MD.xsl" />
      <xsl:include  href="foxslnew/group2/LPL - AMEND - ME.xsl" />
      <xsl:include  href="foxslnew/group2/LPL - AMEND - MN.xsl" />
      <xsl:include  href="foxslnew/group2/LPL - AMEND - MT.xsl" />
      <xsl:include  href="foxslnew/group2/LPL - AMEND - NC.xsl" />
      <xsl:include  href="foxslnew/group2/LPL - AMEND - ND.xsl" /> 
      <xsl:include  href="foxslnew/group2/LPL - AMEND - NH.xsl" />
      <xsl:include  href="foxslnew/group2/LPL - AMEND - OH.xsl" />
      <xsl:include  href="foxslnew/group2/LPL - AMEND - OR.xsl" /> 
      <xsl:include  href="foxslnew/group2/LPL - AMEND - RI.xsl" /> 
      <xsl:include  href="foxslnew/group2/LPL - AMEND - SC.xsl" />
      <xsl:include  href="foxslnew/group2/LPL - AMEND - SD.xsl" />
      <xsl:include  href="foxslnew/group2/LPL - AMEND - VA.xsl" />
      <xsl:include  href="foxslnew/group2/LPL - AMEND - WV.xsl" />
      <xsl:include  href="foxslnew/group2/LPL - AMEND - WY.xsl" />
      <xsl:include  href="foxslnew/group2/LPL - AMEND - CT.xsl" />
      <xsl:include  href="foxslnew/group2/LPL - AMEND - LA.xsl" />
      <xsl:include  href="foxslnew/group2/LPL - AMEND - WA.xsl" />
      <xsl:include  href="foxslnew/group2/LPL - AMEND - WA1.xsl" />
      <xsl:include  href="foxslnew/group2/LPL - AMEND - NV.xsl" />
      <xsl:include  href="foxslnew/group2/LPL - AMEND - TX.xsl" />      
      <xsl:include  href="foxslnew/group2/LPL - AMEND - WY2.xsl" />
      <xsl:include  href="foxslnew/group2/LPL - AMEND - FL.xsl" />
      <xsl:include  href="foxslnew/group2/LPL - AMEND - VT.xsl" />
      
      <xsl:include  href="foxslnew/group2/LPL - NOTICE - TX.xsl" />      
      <xsl:include  href="foxslnew/HotlineNoticeLW.xsl" />
      
      <!-- Group 3 States -->
      <xsl:include  href="foxslnew/group3/LPL - AMEND - CO.xsl" />
      
      <xsl:include  href="foxslnew/group3/FM_2_0_1033_03_12.xsl" />
      <xsl:include  href="foxslnew/group3/MI_43_002_06_15.xsl" />
      <xsl:include  href="foxslnew/group3/CODisclosureForm.xsl" />      
      <xsl:include  href="foxslnew/group3/MO_42_001_06_15_policy.xsl" />
		    ...
		    <fo:page-sequence master-reference="A4-portrait">		
				...
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:block>
						...
						<fo:block break-after="page" />	
						<xsl:call-template name="LPL-State-NJ-2013" />
						<fo:block break-after="page" />	
						...
						<xsl:call-template name="LPL-AMEND-NM" />
						<fo:block break-after="page" />
