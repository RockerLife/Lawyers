...
<xsl:stylesheet version="1.1"
	...
	<xsl:template name="Policycoverletter1" match="/">
		...
		<fo:block margin-top="3.5cm"></fo:block>
		...
		<fo:block font-weight="bold" text-indent="1.5cm" font-size="12px"
			text-align="left">1. Automatic Extended Reporting Period</fo:block>
		...
		<fo:block font-size="10px" start-indent="2cm" text-align="left">
			...
			VI., General Condition A., Notice of <fo:inline font-weight="bold">Claim</fo:inline> or Circumstance, paragraph
			1. Coverage under this extension of time to report a <fo:inline font-weight="bold">Claim</fo:inline> (referred to
		...
		<fo:block font-size="10px" text-align="left" start-indent="2cm">		
			&#160;&#160; &#160; 	Extended Reporting Period shall not be applicable, however, in the event the Named Insured has  
		</fo:block>
		<fo:block font-size="10px" text-align="left" start-indent="2cm">		
		...
		<fo:block margin-top="5cm"></fo:block>
		<fo:block font-size="9px" color="grey" text-align="left">
						 	<xsl:choose>
						     	<xsl:when test="response/address_freeform_01/data/StateCode = 'NM' and response/NMRatingVersion = 'NM2'">
						     		LPL-100 (04/19)&#160; &#160; &#160; &#160; &#160; &#160; &#160;
		...
		<fo:block font-size="10px" start-indent="2cm" text-align="left">
			...
			A., Notice of <fo:inline font-weight="bold">Claim</fo:inline> or Circumstance, paragraph 1.
		</fo:block>
		<fo:block margin-top="2mm" />
		<fo:block font-size="10px" start-indent="2cm" text-align="left">
		...
		<fo:block font-size="10px" start-indent="2.5cm" text-align="left">
			...
			A., Notice of <fo:inline font-weight="bold">Claim</fo:inline> or Circumstance, paragraph 1. Coverage under any
		...
		<fo:block margin-top="4cm"></fo:block>
		<fo:block font-size="9px" color="grey" text-align="left">
							<xsl:choose>
						     	<xsl:when test="response/address_freeform_01/data/StateCode = 'NM' and response/NMRatingVersion = 'NM2'">
						     		LPL-100 (04/19)&#160; &#160; &#160; &#160; &#160; &#160; &#160;
		...
		<fo:block margin-top="3.7cm"></fo:block>
		<fo:block font-size="9px" color="grey" text-align="left">
							<xsl:choose>
						     	<xsl:when test="response/address_freeform_01/data/StateCode = 'NM' and response/NMRatingVersion = 'NM2'">
						     		LPL-100 (04/19)&#160; &#160; &#160; &#160; &#160; &#160; &#160;
		...
		<fo:block font-size="10px" start-indent="1.5cm" text-align="left">
			...
			first initiates an investigation of any <fo:inline font-weight="bold">Insured</fo:inline> during the <fo:inline font-weight="bold">Policy</fo:inline>
			<fo:inline font-weight="bold">&#160;Period</fo:inline> which arises from <fo:inline font-weight="bold">Professional Services</fo:inline> rendered on or after the
			<fo:inline font-weight="bold">Prior Acts Date</fo:inline> and, such regulatory inquiry is reported to the <fo:inline font-weight="bold">Insurer</fo:inline>
			pursuant to Section VI., General Condition A., Notice of <fo:inline font-weight="bold">Claim</fo:inline> or
			Circumstance, the <fo:inline font-weight="bold">Insurer</fo:inline> will reimburse the <fo:inline font-weight="bold">Named Insured</fo:inline> for attorney
			fees, court and regulatory body costs incurred in responding to such
			inquiry, up to $25,000. This is the maximum amount the <fo:inline font-weight="bold">Insurer</fo:inline> will
			reimburse, regardless of the number of such inquiries or of the number
			of <fo:inline font-weight="bold">Insureds</fo:inline> involved in such inquiries, for all inquiries first
			initiated against the <fo:inline font-weight="bold">Insureds</fo:inline> during the <fo:inline font-weight="bold">Policy Period</fo:inline> and reported to
			the <fo:inline font-weight="bold">Insurer</fo:inline> pursuant to Section VI., General Condition A., Notice of
			<fo:inline font-weight="bold">Claim</fo:inline> or Circumstance. Any payments made regarding such inquiry will be
			in addition to the Limit of Liability and are not subject to the
			Deductible.
		</fo:block>
		<fo:block margin-top="2mm" />
		<fo:block font-weight="bold" text-indent="1cm" font-size="12px"
		...
		<fo:block font-size="10px" start-indent="1.5cm" text-align="left">
			...
			Date</fo:inline> and such receipt of a subpoena is reported to the <fo:inline font-weight="bold">Insurer</fo:inline> pursuant
			to Section VI., General Condition A., Notice of <fo:inline font-weight="bold">Claim</fo:inline> or Circumstance,
			then if:
		</fo:block>
		<fo:block font-size="10px" start-indent="1.5cm" text-align="left">
		...
		<fo:block font-size="10px" start-indent="1.5cm" text-align="left">
			the <fo:inline font-weight="bold">Insurer</fo:inline> will retain an attorney to provide advice to the <fo:inline font-weight="bold">Insured</fo:inline>
			regarding the production of documents, to prepare the <fo:inline font-weight="bold">Insured</fo:inline> for sworn
			testimony and to represent the <fo:inline font-weight="bold">Insured</fo:inline> at depositions. Any notice the
			<fo:inline font-weight="bold">Insured</fo:inline> gives the <fo:inline font-weight="bold">Insurer</fo:inline> of such subpoena shall be deemed notification
			of a potential Claim under Section VI., General Condition A., Notice of
			<fo:inline font-weight="bold">Claim</fo:inline> or Circumstance. Any payments made regarding such subpoena will
			be in addition to the Limit of Liability and are not subject to the
			Deductible.
		</fo:block>
		<fo:block margin-top="2mm" />
		<fo:block font-weight="bold" text-indent="1cm" font-size="12px"
		...
		<fo:block font-size="10px" start-indent="1.5cm" text-align="left">
			2. such allegations are reported to the <fo:inline font-weight="bold">Insurer</fo:inline> pursuant to Section
			VI., General Condition A., Notice of <fo:inline font-weight="bold">Claim</fo:inline> or 
		</fo:block>
		<fo:block font-size="10px" text-align="left" start-indent="1.5cm">		
			&#160; &#160;&#160;Circumstance,
		</fo:block>
		<fo:block font-size="10px" start-indent="1.5cm" text-align="left">
			...
			clients making such allegations. The <fo:inline font-weight="bold">Insurer</fo:inline> shall provide its consent,
			not to be unreasonably withheld, to the <fo:inline font-weight="bold">Named Insured’s</fo:inline> choice of
			counsel in connection with defending such allegations. This policy
			shall not, however, provide coverage for <fo:inline font-weight="bold">Damages</fo:inline> resulting from such
			allegations. Notwithstanding anything in this policy to the contrary,
			any <fo:inline font-weight="bold">Defense Expenses</fo:inline> incurred regarding such allegations will be in
			addition to the Limit of Liability and are not subject to the
			Deductible.
		</fo:block>
		<fo:block margin-top="2mm" />
		...
		<fo:block margin-top="2mm" />
		<fo:block font-size="10px" start-indent="1.5cm" text-align="left">
			Disciplinary Proceedings are not <fo:inline font-weight="bold">Claims</fo:inline> under this policy. The <fo:inline font-weight="bold">Insurer</fo:inline>
			will reimburse the <fo:inline font-weight="bold">Named Insured</fo:inline> up to $25,000 for each <fo:inline font-weight="bold">Insured</fo:inline> and all
			...
			resulting from any one Disciplinary Proceeding incurred as the result
			of a notice of such Disciplinary Proceeding both first received by the
			<fo:inline font-weight="bold">Insured</fo:inline> and reported in writing to the <fo:inline font-weight="bold">Insurer</fo:inline> either during the <fo:inline font-weight="bold">Policy
			Period</fo:inline> or within 60 days after termination of the <fo:inline font-weight="bold">Policy Period</fo:inline>,
			arising out of an act, error or omission in the rendering of
			<fo:inline font-weight="bold">Professional Services</fo:inline> by such <fo:inline font-weight="bold">Insured</fo:inline>. The amount payable hereunder
			shall not exceed $25,000 despite the number of such proceedings
			reported to the <fo:inline font-weight="bold">Insurer</fo:inline> during the <fo:inline font-weight="bold">Policy Period</fo:inline> pursuant to Section
			VI., General Condition A., Notice of <fo:inline font-weight="bold">Claim</fo:inline> or Circumstance. Any
			payments made regarding such proceedings will be in addition to the
			Limit of Liability and are not subject to the Deductible.
		</fo:block>
		<fo:block margin-top="2mm" />
		<fo:block font-weight="bold" text-indent="1cm" font-size="12px"
		...
		<fo:block margin-top="2mm" />
		<fo:block font-size="10px" start-indent="1.5cm" text-align="left">
			The <fo:inline font-weight="bold">Insurer</fo:inline> will reimburse the <fo:inline font-weight="bold">Named Insured</fo:inline> up to $20,000 for <fo:inline font-weight="bold">Crisis
			Event Expenses</fo:inline> that result from a <fo:inline font-weight="bold">Crisis Event</fo:inline> first occurring and
			reported in writing to the <fo:inline font-weight="bold">Insurer</fo:inline> during the <fo:inline font-weight="bold">Policy Period</fo:inline> pursuant to
			Section 
		</fo:block>
		...
		<fo:block font-size="10px" start-indent="1.5cm" text-align="left">
			VI., General Condition A., Notice of <fo:inline font-weight="bold">Claim</fo:inline> or Circumstance. Any
			payments made regarding such event will be in 
		</fo:block>
		<fo:block font-size="10px" text-align="left" start-indent="1.5cm">		
			&#160; &#160;&#160; &#160; addition to the Limit of
			Liability and are not subject to the Deductible.
		</fo:block>
		<fo:block margin-top="2mm" />
		<fo:block font-weight="bold" 
			font-size="12px" text-align="left">
		...
		<fo:block font-size="10px" text-align="left" start-indent="1.5cm"><fo:inline font-weight="bold">Defense Expenses</fo:inline> do not include:</fo:block>
                  ...
                  <fo:list-item-body>
                    <fo:block start-indent="1.5cm">
                     ...
                     <fo:block margin-top="3mm"></fo:block>
                     <fo:block  margin-top="0.8cm"></fo:block>
                     <fo:block font-size="9px" color="grey" text-align="left">
							<xsl:choose>
						     	<xsl:when test="response/address_freeform_01/data/StateCode = 'NM' and response/NMRatingVersion = 'NM2'">
						     		LPL-100 (04/19)&#160; &#160; &#160; &#160; &#160; &#160; &#160;
                  ...
                  <fo:list-item-body>
					...
					<fo:block font-size="10px" text-align="left" start-indent="1.5cm">&#160; &#160; &#160; &#160;&#160;profession of the practice of law does not indemnify the Insured or have insurance coverage applicable </fo:block>
					<fo:block font-size="10px" text-align="left" start-indent="1.5cm">&#160; &#160; &#160; &#160;&#160;to the Insured in respect of such services; and</fo:block>
                  ...
                  <fo:list-item-body>
                    <fo:block start-indent="1.5cm">
                      <fo:block space-after="3mm"><fo:inline font-weight="bold">Totally and Permanently Disabled</fo:inline> means that the <fo:inline font-weight="bold">Insured</fo:inline> is so disabled as to be wholly prevented from rendering <fo:inline font-weight="bold">Professional Services</fo:inline> provided that such disability:
                       <fo:block font-size="10px" text-align="left" start-indent="1.5cm">1.&#160;&#160;&#160;&#160;&#160;has existed continuously for not less than six months; and</fo:block>
                        <fo:block font-size="10px" text-align="left" start-indent="1.5cm">2.&#160;&#160;&#160;&#160;&#160;is reasonably expected to be continuous and permanent.</fo:block>
				...
				<fo:block>
                  ...
                  <fo:list-item-body>
                    <fo:block start-indent="1cm">
					  ...
					  <fo:block  margin-top="3mm"></fo:block>
					  <fo:block start-indent="1cm">This policy does not apply to any Claim based upon or arising out of:</fo:block>
                      <fo:block  margin-top="3mm"></fo:block>
                  ...
                  <fo:list-item-body>
                   ...
                   <fo:block>
					 ...
					 <fo:list-item-body>
					 <fo:block start-indent="2cm" >physical injury to, or destruction of any tangible property, including any resulting loss of use thereof. However this exclusion shall not apply to accounting records of clients of the Named Insured.</fo:block>
					 </fo:list-item-body>
					 </fo:list-item>
                   ...
                   <fo:block margin-top="2mm">
					 ...
					 <fo:list-item-body>
					 <fo:block start-indent="1.5cm" >1.&#160;&#160;an Insured’s capacity as a fiduciary under the Employee Retirement Income Security Act of 1974 and </fo:block>
                   ...
                   <fo:block>
					 ...
					 <fo:list-item-body>
					 <fo:block start-indent="2.5cm" >a court of competent jurisdiction deems an Insured to be a fiduciary under such Act solely by reason of Professional Services an Insured rendered to any employee benefit plan; or</fo:block>
					 </fo:list-item-body>
					 </fo:list-item>
                ...
                <fo:block>
					 ...
					 <fo:list-item-body>
					 <fo:block start-indent="2.5cm" >an Insured is appointed as a Receiver, Trustee or Custodian of an employee benefit plan by a court of law; or</fo:block>
					 </fo:list-item-body>
					 </fo:list-item>
           ...
           <fo:block>
                  ...
                  <fo:list-item-body>
                    <fo:block start-indent="1.5cm">
                      <fo:block ><fo:inline font-weight="bold">Professional Services </fo:inline>performed for any person or entity by an Insured if at the time of any negligent act, error or omission giving rise to the <fo:inline font-weight="bold">Claim:</fo:inline>
                      
					  </fo:block>
					   <fo:block start-indent="1.5cm" >1.&#160;&#160;&#160;such <fo:inline font-weight="bold">Professional Services</fo:inline> were rendered to an <fo:inline font-weight="bold">Immediate Family Member;</fo:inline></fo:block>
					  
					  <fo:block start-indent="1.5cm" >2.&#160;&#160;&#160;such <fo:inline font-weight="bold">Insured</fo:inline> or their <fo:inline font-weight="bold">Immediate Family Member</fo:inline> controlled or owned more than 10% equity interest, </fo:block>
					  <fo:block start-indent="1.5cm" >&#160;&#160;&#160; &#160;&#160;operated or managed such entity; or</fo:block>
					  <fo:block start-indent="1.5cm" >3.&#160;&#160;&#160;such <fo:inline font-weight="bold">Insured</fo:inline> or their <fo:inline font-weight="bold">Immediate Family Member</fo:inline> was a partner, member, director, officer or employee </fo:block>
					  <fo:block start-indent="1.5cm" >&#160;&#160;&#160;&#160; &#160;of such entity.</fo:block>
				 ...
				 <fo:block>
                  ...
                  <fo:list-item-body>
                    <fo:block start-indent="1.5cm">
					  ...
					  <fo:block start-indent="1.5cm" >2.&#160;&#160;&#160;&#160;&#160;the breach of any express warranty of any contract unless such liability would have attached to the <fo:inline font-weight="bold">Insured</fo:inline> </fo:block>
					  <fo:block start-indent="1.5cm" >&#160; &#160; &#160;&#160;even in the absence of such contract or agreement.</fo:block>
					   <fo:block  margin-top="3mm"></fo:block>
				...
				<fo:block>
                  ...
                  <fo:list-item-body>
                    <fo:block start-indent="1.5cm">
					   ...
					   <fo:block start-indent="1.5cm" >1.&#160;&#160;&#160;&#160;&#160;defects in title of which the Insured had knowledge as of the date of issuance of any title policy; or</fo:block>
				...
				<fo:block>
                  ...
                  <fo:list-item-body>
                    <fo:block start-indent="1.5cm">
					   ...
					   <fo:block start-indent="1.5cm" >a notarized certification or acknowledgment of signature without an identity check and physical appearance before the Insured performing such notarization of the person whose signature was notarized or acknowledged.</fo:block>
            ...
            <fo:block font-weight="bold"  text-indent="1cm"
                  text-align="left">A. Notice of Claim or Circumstance </fo:block>
            <fo:block margin-top="3mm"></fo:block>
            ...
            <fo:block font-size="10px" text-align="left" start-indent="1.5cm">
                  ...
                  under this policy, give written
            </fo:block>
            <fo:block font-size="10px" text-align="left" start-indent="1.9cm">
                  notice of a
            ...
            <fo:block font-size="10px" text-align="left" start-indent="2.5cm">(b)
            ...
            <fo:block font-size="10px" text-align="left" start-indent="2.5cm">(c)
            ...
            <fo:block font-size="10px" text-align="left" start-indent="1.9cm">
                  any facts or circumstances that may reasonably be expected to give
                  rise to a
                  <fo:inline font-weight="bold"> Claim </fo:inline>
                  and, written notice is given to the <fo:inline font-weight="bold">Insurer</fo:inline> in accordance with paragraphs 1. and 3. of this Section A. of:
            </fo:block>
            <fo:block margin-top="2mm" />
            <fo:block font-size="10px" text-align="left" start-indent="2cm">
                  (a) such facts or circumstances, as well as the reasons for
                  anticipating such a
                  <fo:inline font-weight="bold"> Claim</fo:inline>;
             
            </fo:block>
            <fo:block font-size="10px" text-align="left" start-indent="2cm">
                  (b) specific information as to the expected negligent act, error,
                  omission,
                  <fo:inline font-weight="bold">Personal Injury </fo:inline>
                  or
                  <fo:inline font-weight="bold">Advertising </fo:inline>
            </fo:block>
            <fo:block font-size="10px" text-align="left" start-indent="2.1cm">
            <fo:inline font-weight="bold">&#160; &#160;&#160; Liability; </fo:inline>
            </fo:block>
            ...
            <fo:block font-size="10px" text-align="left" text-indent="2cm">Crum
                  &amp; Forster</fo:block>
            <fo:block font-size="10px" text-align="left" text-indent="2cm">Claims
                  Department</fo:block>
            <fo:block font-size="10px" text-align="left" text-indent="2cm">305
                  Madison Avenue</fo:block>
            <fo:block font-size="10px" text-align="left" text-indent="2cm">Morristown,
                  New Jersey 07962</fo:block>
            <fo:block font-size="10px" text-align="left" text-indent="2cm">mapsnol@cfins.com
            </fo:block>
            ...
            <fo:block margin-top="2mm" />
				...
				<fo:block margin-top="2mm"/>
				<fo:block font-size="10px" text-align="left" start-indent="1.5cm">3.&#160;&#160;This policy may be non renewed by the <fo:inline font-weight="bold" >Insurer</fo:inline> by mailing or delivering to the <fo:inline font-weight="bold" >Named Insured</fo:inline>, </fo:block>
				...
				<fo:block margin-top="18cm"  font-size="10px" color="grey" text-align="left">
				</fo:block>	
				<fo:block font-size="9px" color="grey" text-align="left">
