...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/" name="LPL1212012">
				    ...
				    <fo:block space-after=".1in" text-align-last="justify">
				     ...
				     <fo:block margin-top="10mm"/>
				    <fo:block  font-size="10px">In consideration of the premium charged it is agreed that the coverage afforded by this policy shall apply to a <fo:inline font-weight="bold" >Claim</fo:inline> first made and reported to the <fo:inline font-weight="bold" >Insurer</fo:inline> during the <fo:inline font-weight="bold" >Policy Period</fo:inline> against:</fo:block>
	         	...
	         	<fo:block  font-size="10px" color="grey" text-align="left">LPL - 121 (04/17)</fo:block> 
     </xsl:template>
</xsl:stylesheet>
