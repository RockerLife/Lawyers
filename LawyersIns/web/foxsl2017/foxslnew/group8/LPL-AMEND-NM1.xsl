...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/" name="LPL-AMEND-NM1">
	...
	<fo:block margin-top="3mm"></fo:block>
          ...
          <fo:block font-size="12px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" font-weight="bold" text-align="center" space-after="8mm">
            (DEFENSE EXPENSES OUTSIDE THE LIMIT AND DEDUCTIBLE)
          </fo:block>
          ...
          <fo:block>
            <fo:list-block provisional-distance-between-starts="0.8cm" provisional-label-separation="0.15cm">
              <fo:list-item>
                ...
                <fo:list-item-body start-indent="7mm">
                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" text-align="justify">
                    Section I., Insuring Agreement A., Coverage, is deleted and replaced with the following:
                  </fo:block>
                  <fo:block>
                    <fo:list-block provisional-distance-between-starts="0.8cm" provisional-label-separation="0.15cm">
                      <fo:list-item>
                        ...
                        <fo:list-item-body start-indent="14mm">
                          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" font-weight="bold"  text-align="justify" space-after="3mm">
                            Coverage
                          </fo:block>
                          
                          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;"  text-align="justify">
                            Subject to the Limit of Liability stated in Item 3. of the Declarations and as limited in Section II., the <fo:inline font-weight="bold">Insurer</fo:inline> shall pay on behalf of the <fo:inline font-weight="bold">Insured</fo:inline> all <fo:inline font-weight="bold">Damages</fo:inline> in excess of the Deductible shown in Item 4. of the Declarations and as limited in Section II., and all <fo:inline font-weight="bold">Defense Expenses,</fo:inline> that the <fo:inline font-weight="bold">Insured</fo:inline> becomes legally obligated to pay as a result of a <fo:inline font-weight="bold">Claim</fo:inline> first made against the <fo:inline font-weight="bold">Insured</fo:inline> and reported in writing to the <fo:inline font-weight="bold">Insurer</fo:inline> during:
                          </fo:block>
                          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="justify">
                          ...
                          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" text-align="justify">
                            by reason of a negligent act, error or omission in the performance of <fo:inline font-weight="bold">Professional Services</fo:inline> by the <fo:inline font-weight="bold">Insured</fo:inline> or by someone for whom the <fo:inline font-weight="bold">Insured</fo:inline> is legally responsible, provided that such negligent act, error or omission began on or after the <fo:inline font-weight="bold">Prior Acts Date</fo:inline> shown in Item 6. of the Declarations.
                          </fo:block>
                          <fo:block margin-top="3mm"></fo:block>
                        </fo:list-item-body>
                      </fo:list-item>
              ...
              <fo:list-item>
                ...
                <fo:list-item-body start-indent="7mm">
                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" text-align="justify">
                    Section II., Limits of Liability and Deductible, is deleted and replaced with the following:
                  </fo:block>
                  <fo:block>
                    <fo:list-block provisional-distance-between-starts="0.8cm" provisional-label-separation="0.15cm">
                      <fo:list-item>
                        ...
                        <fo:list-item-body start-indent="14mm">
                          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" font-weight="bold" text-align="justify">
                            LIMITS OF LIABILITY AND DEDUCITBLE
                          </fo:block>
                          <fo:block>
                            <fo:list-block provisional-distance-between-starts="0.8cm" provisional-label-separation="0.15cm">
                              <fo:list-item>
                                  ...
                                  <fo:block>
                                    <fo:list-block provisional-distance-between-starts="0.8cm" provisional-label-separation="0.15cm">
                                      ...
                                      <fo:list-item>
                                        ...
                                        <fo:list-item-body start-indent="28mm">
                                          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="justify">
                                            Subject to 1. above, the <fo:inline font-weight="bold">Insurer's</fo:inline> Limit of Liability for <fo:inline font-weight="bold">Damages,</fo:inline> for all <fo:inline font-weight="bold">Claims</fo:inline> first made and reported to the <fo:inline font-weight="bold">Insurer</fo:inline> during the <fo:inline font-weight="bold">Policy Period,</fo:inline> including any applicable Extended Reporting Period, shall not exceed the amount shown in Item 3. of the Declarations as applicable to <fo:inline font-weight="bold">"Policy Aggregate"</fo:inline>.
                                          </fo:block>
                                        </fo:list-item-body>
                                      </fo:list-item>
                                      ...
                                      <fo:list-item>
                                        ...
                                        <fo:list-item-body start-indent="28mm">
                                          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="justify">
                                            The Limit of Liability shall apply excess of the Deductible amount.
                                          </fo:block>
                                      ...
                                      <fo:list-item>
                                        ...
                                        <fo:list-item-body start-indent="28mm">
                                          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="justify">
                                            The Limit of Liability available for <fo:inline font-weight="bold">Claims</fo:inline> first made against the <fo:inline font-weight="bold">Insured</fo:inline> and reported to the <fo:inline font-weight="bold">Insurer</fo:inline> during any applicable Extended Reporting Period, is part of, and not in addition to the Limit of Liability shown in Item 3. of the Declarations. Applicable Extended Reporting Periods shall not provide a new, additional or renewed Limit of Liability.
                                          </fo:block>
                                        </fo:list-item-body>
                                      </fo:list-item>
                                      ...
                                      <fo:list-item>
                                        ...
                                        <fo:list-item-body start-indent="28mm">
                                          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" text-align="justify">
                                            If the <fo:inline font-weight="bold">Insurer</fo:inline> has exhausted the applicable Limit of Liability by payment of <fo:inline font-weight="bold">Damages</fo:inline> or by tender of the remaining Limit of Liability into court, it shall have no further duties to the <fo:inline font-weight="bold">Insured</fo:inline> under this policy.
                                          </fo:block>
                                          <fo:block margin-top="3mm"></fo:block>
                                        </fo:list-item-body>
                                      </fo:list-item>
              ...
              <fo:list-item-body>
               <fo:block  font-size="10px" color="grey" text-align="left">LPL-AMEND-NM1 (04/19)
                ...
                <fo:list-item-body start-indent="7mm">
                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" text-align="justify">
                    ...
                    <fo:list-block provisional-distance-between-starts="0.8cm" provisional-label-separation="0.15cm">
                      <fo:list-item>
                        <fo:list-item-label start-indent="7mm">
                          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">M.</fo:block>
                        </fo:list-item-label>
                        <fo:list-item-body >
                          <fo:block start-indent="14mm" font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" text-align="justify">
                            <fo:inline font-weight="bold">Policy Aggregate</fo:inline> means the amount shown in Item 3.  of the Declarations which represents the maximum amount of the <fo:inline font-weight="bold">Insurer's</fo:inline> liability for all <fo:inline font-weight="bold">Claims</fo:inline> and all <fo:inline font-weight="bold">Damages</fo:inline> combined under this policy, inclusive of any applicable Extended Reporting Period.
                          </fo:block>
                          <fo:block margin-top="3mm"></fo:block>
                        </fo:list-item-body>
                      </fo:list-item>
                  ...
                  <fo:block>
                    <fo:list-block provisional-distance-between-starts="0.8cm" provisional-label-separation="0.15cm">
                      <fo:list-item>
                        ...
                        <fo:list-item-body start-indent="14mm">
                          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" text-align="justify">
                            The <fo:inline font-weight="bold">Insurer</fo:inline> shall have the right and the duty to defend any <fo:inline font-weight="bold">Claim</fo:inline> regardless of whether the allegations are groundless, false, or fraudulent. In undertaking this right and duty, the <fo:inline font-weight="bold">Insurer</fo:inline> expressly retains the right to select defense counsel even when the <fo:inline font-weight="bold">Insurer</fo:inline> reserves its rights on issues concerning the applicability of coverage under this policy. The <fo:inline font-weight="bold">Insurer's</fo:inline> right and duty to defend any <fo:inline font-weight="bold">Claim</fo:inline> and pay <fo:inline font-weight="bold">Defense Expenses</fo:inline> shall terminate upon the exhaustion of the Limit of Liability, whereupon the <fo:inline font-weight="bold">Insurer</fo:inline> shall have no further obligation or liability to defend the <fo:inline font-weight="bold">Insured</fo:inline> or to pay <fo:inline font-weight="bold">Defense Expenses,</fo:inline> judgments or settlements. The  <fo:inline font-weight="bold">Insurer</fo:inline> may make any investigation it deems necessary and may, with the <fo:inline font-weight="bold">Insured's</fo:inline> consent, such consent not to be unreasonably withheld, make any settlement of any <fo:inline font-weight="bold">Claim </fo:inline> it deems expedient. If the <fo:inline font-weight="bold">Insured</fo:inline> withholds consent of such settlement, the <fo:inline font-weight="bold">Insurer's</fo:inline> liability for all <fo:inline font-weight="bold">Damages</fo:inline> on account of such <fo:inline font-weight="bold">Claim</fo:inline> shall not exceed the amount for which the <fo:inline font-weight="bold">Insurer</fo:inline> could have settled such <fo:inline font-weight="bold">Claim,</fo:inline> inclusive of <fo:inline font-weight="bold">Defense Expenses,</fo:inline> incurred as of the date such settlement was proposed to the <fo:inline font-weight="bold">Insured</fo:inline>.
                          </fo:block>                         
                        </fo:list-item-body>
                      </fo:list-item>
                    </fo:list-block>
