...
<xsl:stylesheet version="1.1"
	...
	xmlns:java="java">
  <xsl:template match="/" name="LPL-117-NMNew">
          <fo:block>				  	
			<xsl:call-template name="CommonHeader" />						           	
		  </fo:block>


          <fo:block text-align="justify" margin-left="1.3in" margin-right="1.3in" font-size="12px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-before="5mm" space-after="5mm" font-weight="bold">

           AGGREGATE DEDUCTIBLE FOR ALL CLAIMS – NEW MEXICO
          ...
          <fo:block padding-left="5pt" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" font-size="10px" text-align="justify">
              ...
              <fo:list-block provisional-label-separation="0.15cm">
                <fo:list-item space-after="4mm">
                  ...
                  <fo:list-item-body start-indent="12mm">
                    <fo:block>
                      <fo:inline>an additional premium of $
                    </fo:inline>                      
                    </fo:block>
                  </fo:list-item-body>
                </fo:list-item>
            ...
            <fo:block space-after="4mm">
           and notwithstanding anything to the contrary in New Mexico Amendatory Endorsement, LPL-AMEND-NM1, LPL-AMEND-NM2, LPL-AMEND-NM3 or LPL-AMEND-NM4, it is agreed that: </fo:block>
                ...
                <fo:list-item space-after="4mm">
                  ...
                  <fo:list-item-body>
                    ...
                    <fo:block space-after="3mm" start-indent="7mm">
                     Item 4. of the Declarations, Deductible, is deleted and replaced with the following:                 </fo:block>
                      <fo:block>
                        ...
                        <fo:table-body>
                          ...
                          <fo:table-row>
                            ...
                            <fo:table-cell border="0.2pt solid black"  padding="2pt">
                              ...
                              <fo:block text-align="left" text-indent="2mm">
                                <fo:inline><xsl:value-of select="response/policycoverage_freeform_01/data/DeductibleAmount" /> </fo:inline>
                                <fo:inline></fo:inline> 
                                <!--<fo:table>
                ...
                <fo:list-item>
                  ...
                  <fo:list-item-body start-indent="15mm">
                    <fo:block space-after="3mm" start-indent="7mm">
                      ...
                      Section II. of the policy, Limits of Liability and Deductible, subsection B., Deductible, is deleted and replaced with the following: </fo:block>
                      <fo:block space-after="3mm">
            			 <fo:block >Solely for policies with New Mexico Amendatory Endorsement, LPL-AMEND-NM1 or LPL-AMEND-NM3 attached:</fo:block>
                      ...
                      <fo:block start-indent="13mm">
                        ...
                        <fo:block>
                          ...
                          30 days of the Insurer’s request to do so.  In the event of <fo:inline font-weight="bold">Related Claims</fo:inline>, a single Deductible amount will apply.
                        </fo:block>
                        <fo:block margin-top="3mm"></fo:block>
                        <fo:block start-indent="7mm">Solely for policies with New Mexico Amendatory Endorsement, LPL-AMEND-NM2 attached:</fo:block>
                      </fo:block>
                    </fo:block>
                  </fo:list-item-body>
                </fo:list-item>
                  ...
                  <fo:list-item-body start-indent="15mm">
                    <fo:block space-after="3mm" start-indent="7mm">
                      ...
                      <fo:block start-indent="13mm">
                              ...
                              <fo:list-item-body>
                                ...
                                <fo:block start-indent="20mm">
	 							...
	 							<fo:block start-indent="20mm">
									...
									has paid this amount, no further Deductibles shall apply to
									<fo:inline font-weight="bold">Claims</fo:inline>. <fo:inline font-weight="bold">Defense Expenses</fo:inline>
									charged against the Deductible shall not exceed 50% of such Deductible
									and the
									<fo:inline font-weight="bold">Insurer</fo:inline>
									shall assume any
									<fo:inline font-weight="bold">Defense Expenses</fo:inline>
									over that percentage, except for those due to any offset against the
									Limit of Liability. If the
									<fo:inline font-weight="bold">Insurer</fo:inline>
									advances any amounts within the Deductible, the
                        ...
                        <fo:block margin-top="3mm"></fo:block>
                         <fo:block start-indent="7mm">Solely for policies with New Mexico Amendatory Endorsement, LPL-AMEND-NM4 attached:</fo:block>
                        <fo:block  margin-top="2cm"></fo:block>
                        
                        <fo:block start-indent="7mm" font-size="10px" color="grey" text-align="left">LPL-117 (04-19) NM
			...
			<fo:block  font-size="10px" color="grey" text-align="left">LPL-117 (04-19) NM
