...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/" name="LPL-AMEND-NM4">
	...
	<fo:block margin-top="3mm"></fo:block>
          ...
          <fo:block font-size="12px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" font-weight="bold" text-align="center" space-after="8mm">
            (DEFENSE EXPENSES OUTSIDE THE LIMIT AND DEFENSE EXPENSES WITHIN THE DEDUCTIBLE)
          </fo:block>
          ...
          <fo:block>
            <fo:list-block provisional-distance-between-starts="0.8cm" provisional-label-separation="0.15cm">
                            ...
                            <fo:list-block provisional-distance-between-starts="0.8cm" provisional-label-separation="0.15cm">
                              ...
                              <fo:list-item>
                                ...
                                <fo:list-item-body start-indent="21mm">
                                  ...
                                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" text-align="justify">
									<fo:inline font-weight="bold">Defense Expenses</fo:inline> charged against the Deductible shall not exceed 50% of
									such Deductible and the <fo:inline font-weight="bold">Insurer</fo:inline> shall assume any <fo:inline font-weight="bold">Defense Expenses</fo:inline> over
									that percentage. The Deductible amount applies to the payment of
									<fo:inline font-weight="bold">Damages</fo:inline> only and shall not apply to <fo:inline font-weight="bold">Defense Expenses</fo:inline>. If the <fo:inline font-weight="bold">Insurer</fo:inline>
									advances any amounts within the Deductible, the <fo:inline font-weight="bold">Named Insured</fo:inline> shall
									reimburse the <fo:inline font-weight="bold">Insurer</fo:inline> within 30 days of the <fo:inline font-weight="bold">Insurer’s</fo:inline> request to do so.
									In the event of <fo:inline font-weight="bold">Related Claims</fo:inline>, a single Deductible amount will apply.
                                  </fo:block> 
              ...
              <fo:list-item-body>
             <fo:block start-indent="7mm" font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" text-align="justify">
             Section II., Limits of Liability and Deductible, is amended by addition of the following
              </fo:block>
              <fo:block>
               <fo:list-block>
               <fo:list-item>
               ...
               <fo:inline  font-size="10px" font-weight="bold" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">Accounting</fo:inline>
                 ...
                 <fo:block start-indent="21mm" font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" text-align="justify">
                         Where <fo:inline font-weight="bold">Defense Expenses</fo:inline> are applied against the Deductible, the Insurer shall notify the <fo:inline font-weight="bold">Named Insured</fo:inline> of its right, upon written request, to an accounting of <fo:inline font-weight="bold">Defense Expenses</fo:inline> actually expended.
                 </fo:block>
               </fo:list-item-body>
               </fo:list-item>
               </fo:list-block>
              ...
              <fo:list-item>
                <fo:list-item-label>
                  <fo:block>
                    <fo:inline font-weight="bold" font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">3.</fo:inline>
                  </fo:block>
                </fo:list-item-label>
                <fo:list-item-body start-indent="7mm">
                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" text-align="justify">
              ...
              <fo:list-item>
				<fo:list-item-label>
				  ...
				  <fo:list-item-body>
				   <fo:block  font-size="10px" color="grey" text-align="left">LPL-AMEND-NM4 (04/19)
