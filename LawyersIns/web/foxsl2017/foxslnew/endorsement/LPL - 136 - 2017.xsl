...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/" name="Policycoverletter36">
					...
					<fo:block margin-top="2mm">
				     ...
				     <fo:block text-align="center" font-weight="bold"  font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" font-size="12px"  >DELETE ENDORSEMENT FORM</fo:block>
				     ...
				     <fo:block text-align="left" font-size="10px" >In consideration of premium charged, it is agreed that Endorsement # LPL - 102 - (09/10) of this policy hereby deleted, null and void.</fo:block>
	         	...
	         	<fo:block margin-top="10mm"/>
	         	<fo:block  font-size="10px" color="grey" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="left">LPL - 136 - (04/17)</fo:block>
