...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/" name="MT-DWL-Notice-New" >
	<fo:block text-align="left"  space-after="1.5cm">				  	
		...
		<fo:block  font-size="11px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">The undersigned acknowledges that the limit of liability available to pay settlements or judgments will be reduced, and may be exhausted, by defense expenses.</fo:block>
		
		<fo:block font-size="11px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" padding-top="100px">
              ...
              <fo:table-body>
                <fo:table-row>
                  <fo:table-cell display-align="after">
                    <fo:block font-size="11px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="left">
                      SIGNATURE*
                    </fo:block>
                  </fo:table-cell>
          ...
          <fo:block margin-top="11cm"></fo:block>
         <fo:block  font-size="10px" color="grey" text-align="left">MO 42 004 04 17
