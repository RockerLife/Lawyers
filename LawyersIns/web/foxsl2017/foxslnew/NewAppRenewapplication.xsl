...
<xsl:stylesheet version="1.1"
            ...
            <fo:table>
              ...
              <fo:table-body>
                <fo:table-row>
                  ...
                  <fo:table-cell  padding-top="17pt"  number-columns-spanned="3">
                    <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;"
                ...
                <fo:table-row>
                  <fo:table-cell  >
                    <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" start-indent="0.35in" padding-top="10px">
                      Address Line 2:
                  ...
                  <fo:table-cell  padding-top="17pt">
                    <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;"
											border-bottom-width="0.9pt" border-bottom-style="solid"
											border-bottom-color="black">
                     <xsl:value-of select="response/policy_freeform_01/data/CountyDesc"/>
            ...
            <fo:table border="0.9pt solid white">
              ...
              <fo:table-body>
                ...
                <fo:table-row>
                  ...
                  <fo:table-cell border-bottom="0.2pt solid black" display-align="after">
                    <fo:block  font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                       <xsl:value-of select="response/firm_freeform_01/data/otherPhone"></xsl:value-of>&#160;
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
                        ...
                        <fo:table-row>
                          <fo:table-cell>
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="left" margin-top="7px">
                              If <fo:inline> "Yes" </fo:inline>, please update the list below:
                            </fo:block>
                          </fo:table-cell>
                          <fo:table-cell>
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                      ...
                      <fo:table margin-top="2mm">
                        ...
                        <fo:table-body>
                          <fo:table-row>
                            ...
                            <fo:table-cell border="0.5pt solid black">
                              <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="center" font-weight="bold">Annual Hours Worked</fo:block>
                            </fo:table-cell>
                            <fo:table-cell border="0.5pt solid black">
                              <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="center" font-weight="bold">Date Joined the Firm</fo:block>
                            </fo:table-cell>
                            <fo:table-cell border="0.5pt solid black">
                            ...
                            <fo:table-cell border="0.5pt solid black">
                              <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="center" font-weight="bold"># of Years in Practice</fo:block>
                            </fo:table-cell>
                            <!--  	
            ...
            <fo:table>
              ...
              <fo:table-body>
                <fo:table-row>
                  <fo:table-cell  padding-top="17pt" >
                    <fo:block  font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                      3. &#160;&#160;&#160;&#160; &#160;&#160;Enter the percentage of revenue for each area below in the past fiscal year.  Indicate percentages in whole numbers next to &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;the type of law the firm practices :
					</fo:block>
                  </fo:table-cell>
                      ...
                      <fo:table-body>
                        ...
                        <fo:table-row>
                          <fo:table-cell>
                            ...
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="justify" space-after="3mm" start-indent="12mm">
                             of a claim against the firm or its personnel?
                            </fo:block>
                          </fo:table-cell>
                          <fo:table-cell text-align="right">
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                    ...
                    <fo:table border="0.9pt solid white">
                      ...
                      <fo:table-body>
                        <fo:table-row>
                          ...
                          <fo:table-cell>
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="left">
                              a. &#160; In the past year, how many disbursement transactions have you executed from your client
                            </fo:block>
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="left" space-after="3mm" start-indent="12mm">
                              funds account?
                            </fo:block>
                          </fo:table-cell>
 ...
 <fo:block break-after="page"/>
          ...
          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" padding-top="62px">
            <fo:table border="0.9pt solid white">
              <fo:table-column column-width="1.5in"/>
              <fo:table-column column-width="2.5in"/>
              <fo:table-column column-width="1.5in"/>
	...
	<xsl:if test="response/isRealestatePage='Y'">
          ...
          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">
          1. &#160; &#160; Please complete the following chart, providing a breakdown of the firm’s trusts, wills, estate and probate practice based on
          </fo:block>
          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" start-indent="7mm">
