...
<xsl:stylesheet version="1.1"
      ...
      <fo:page-sequence master-reference="A4-portrait" >
	   ...
	   <fo:block>
        ...
        <fo:flow flow-name="xsl-region-body" >
          ...
          <fo:block  font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" start-indent="0.3in" padding-top="10px" padding-bottom="10px">
            If <fo:inline font-weight="bold">"Yes"</fo:inline>, provide the information requested below:
          ...
          <fo:block>
            <fo:table>
              ...
              <fo:table-body>
                <fo:table-row>
                  <fo:table-cell  >
                    <fo:block  font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" start-indent="0.3in" padding-top="10px">
                      Limits of Liability: $
            ...
            <fo:table>
              ...
              <fo:table-body>
                <fo:table-row>
                  ...
                  <fo:table-cell  padding-top="10px" >
                    <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="left"	border-bottom-width="0.9pt" border-bottom-style="solid"	border-bottom-color="black">
                      <xsl:value-of select="response/coverage_freeform_1/data/PriorActDatePross"/>

                    </fo:block>
                    <fo:block font-size="8px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" font-style="italic" text-align="center">
                      MM/DD/YYYY </fo:block>
                  </fo:table-cell>
                  <fo:table-cell   padding-top="10px" start-indent="0.2in">
                    <fo:block  font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="center">
                      Premium : 
            ...
            <fo:table>
              ...
              <fo:table-body>
                <fo:table-row>
                  ...
                  <fo:table-cell >
                    <fo:block  font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" padding-top="16px" >
                      Annual Aggregate
                    </fo:block>
                  </fo:table-cell>
            ...
            <fo:table>
              ...
              <fo:table-body>
                <fo:table-row>
                  <fo:table-cell  padding-top="10px" >
                    <fo:block  font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                      6.&#160;&#160;Enter the percentage of revenue for each area below in the past fiscal year.  Indicate percentages in whole numbers next to
                    </fo:block>
                  </fo:table-cell>
					</fo:table-row>
				<fo:table-row>
                  <fo:table-cell >
                    <fo:block  font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                     &#160;&#160;&#160;&#160;&#160;&#160;the type of law the firm practices :
 ...
 <xsl:if test="response/isBeforeLitigation='Y'">
                    ...
                    <fo:table margin-top="2mm">
                      ...
                      <fo:table-body>
                        <fo:table-row>
                          ...
                          <fo:table-cell border="0.5pt solid black">
                            <fo:block font-size="9px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="center" font-weight="bold">% OF REVENUE</fo:block>
                          </fo:table-cell>
    ...
    <fo:table margin-top="1mm">
          ...
          <fo:block >
            <fo:table margin-top="5mm" border="0.5pt solid black" background-color="LightGray ">
              <fo:table-column></fo:table-column>
              <fo:table-body>
                <fo:table-row>
                  <fo:table-cell>
          ...
          <fo:block>
            <fo:list-block provisional-distance-between-starts="0.8cm" provisional-label-separation="0.15cm">
                      ...
                      <fo:table-body>
                        <fo:table-row>
                          ...
                          <fo:table-cell text-align="right"  >
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" border-bottom="0.2pt solid black">
              ...
              <fo:list-item>
                <fo:list-item-label>
                  <fo:block margin-bottom="5px" margin-top="10px">
                  ...
                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm">
                    <fo:table border="0.2pt solid white">
                      ...
                      <fo:table-body>
                        <fo:table-row>
                          <fo:table-cell>
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="justify" space-after="4mm" margin-bottom="5px" margin-top="12px">
                          ...
                          <fo:table-cell text-align="right">
                            ...
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" margin-bottom="5px" margin-top="10px">
                            
                               <xsl:choose>
                            <xsl:when test="response/firm_freeform_01/data/haveBackupAttorney = 'Y'">
                            Yes <fo:inline font-family="ZapfDingbats" font-size="8pt" border="1pt black solid">&#x2714;</fo:inline> &#160; No <fo:inline font-family="ZapfDingbats" font-size="8pt" border="1pt black solid">&#xA0;&#xA0;&#xA0;</fo:inline>
                            </xsl:when>
                            <xsl:when test="response/firm_freeform_01/data/haveBackupAttorney = 'N'">
                            Yes <fo:inline font-family="ZapfDingbats" font-size="8pt" border="1pt black solid">&#xA0;&#xA0;&#xA0;</fo:inline> &#160; No <fo:inline font-family="ZapfDingbats" font-size="8pt" border="1pt black solid">&#x2714;</fo:inline>
                            </xsl:when>
                            <xsl:otherwise>
                             Yes <fo:inline font-family="ZapfDingbats" font-size="8pt" border="1pt black solid">&#xA0;&#xA0;&#xA0;</fo:inline> &#160; No <fo:inline font-family="ZapfDingbats" font-size="8pt" border="1pt black solid">&#xA0;&#xA0;&#xA0;</fo:inline>
                    ...
                    <fo:table border="0.2pt solid white">
                      ...
                      <fo:table-body>
                        ...
                        <fo:table-row>
                          <fo:table-cell>
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="justify">
                              a. &#160; &#160; If <fo:inline font-weight="bold"> "Yes" </fo:inline>, were you the majority successor in interest to the financial assets and liabilities of the
                            </fo:block>
                        ...
                        <fo:table-row>
                          <fo:table-cell>
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="justify" space-after="4mm">
                              b. &#160; &#160; If<fo:inline font-weight="bold"> "Yes" </fo:inline>, do you desire coverage for this entity as a predecessor firm?
                            </fo:block>
                          </fo:table-cell>
                          <fo:table-cell text-align="right">
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm">
                        ...
                        <fo:table-row>
                          <fo:table-cell>
                            <fo:block start-indent="0.4in" font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="justify" space-after="4mm">
                              If <fo:inline font-weight="bold"> "Yes" </fo:inline> to a or b above, complete the <fo:inline font-weight="bold" font-style="italic"> Predecessor Firm Supplement. </fo:inline>
                            </fo:block>
                          </fo:table-cell>
                          <fo:table-cell text-align="right">
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm">
              ...
              <fo:list-item>
                ...
                <fo:list-item-body start-indent="3mm">
                  ...
                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="justify" margin-bottom="10px" start-indent="0.25in">
                    If <fo:inline font-weight="bold"> "Yes" </fo:inline> please complete the <fo:inline font-weight="bold" font-style="italic"> Fee Suit Supplement. </fo:inline>
                  </fo:block>
                </fo:list-item-body>
              </fo:list-item>
              ...
              <fo:list-item>
                ...
                <fo:list-item-body start-indent="3mm">
                  ...
                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="justify" margin-bottom="10px" start-indent="0.25in" >
                    If <fo:inline font-weight="bold"> "Yes" </fo:inline> please explain.
                  </fo:block>
                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm">
                    <fo:table border="0.2pt solid white">
                    ...
                    <fo:table border="0.2pt solid white">
                      ...
                      <fo:table-body>
                        ...
                        <fo:table-row>
                          ...
                          <fo:table-cell>
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;"  text-align="justify">
                              b. &#160; Are you providing business management or negotiation of performance or professional
                            </fo:block>
                        ...
                        <fo:table-row>
                          ...
                          <fo:table-cell>
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm">
                              c. &#160; Are you providing money management or investment advice services to such clients?
                            </fo:block>
                          </fo:table-cell>
                          <fo:table-cell text-align="right">
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm">
              ...
              <fo:list-item>
                ...
                <fo:list-item-body start-indent="3mm">
                  ...
                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="3mm" start-indent="0.25in">
                    If "Yes", please identify and explain the relevant legal services.
                  </fo:block>
                    ...
                    <fo:table >
                      ...
                      <fo:table-body>
                        <fo:table-row>
                          <fo:table-cell >
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" margin-bottom="10px">
                              If <fo:inline font-style="italic"> "Yes" </fo:inline>, please describe:
                            </fo:block>
                          </fo:table-cell>
...
<xsl:value-of select="response/firm_freeform_01/data/peopleToDisburseFunds"></xsl:value-of>
              ...
              <fo:list-item>
                ...
                <fo:list-item-body start-indent="7mm">
                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" margin-top="10px">
                    If your firm has three or more attorneys, please provide your professional liability insurance history for the three years prior to your current carrier:
                  </fo:block>
                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm">
                    <fo:table border="0.2pt solid black">
                      <fo:table-column column-width="2.5in"/>
            ...
            <fo:list-block provisional-distance-between-starts="0.8cm" provisional-label-separation="0.15cm">
              ...
              <fo:list-item>
                ...
                <fo:list-item-body start-indent="7mm">
                    ...
                    <fo:table border="0.2pt solid white">
                      ...
                      <fo:table-body>                        
                        <fo:table-row>
                          <fo:table-cell>
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="justify" >
                             a. &#160; &#160; been the subject of any regulatory investigation or inquiry; suspended or disbarred from practice; &#160; &#160;&#160; &#160;&#160; &#160;or charged, indicted or been convicted of any criminal charge?
                            </fo:block>
                          </fo:table-cell>
                          <fo:table-cell text-align="right">
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" >
                        ...
                        <fo:table-row>
                          <fo:table-cell>
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="justify" space-after="4mm" margin-bottom="7px">
                              If <fo:inline font-style="italic" font-weight="bold"></fo:inline> "Yes", please provide details and dates:
                            </fo:block>
                          </fo:table-cell>
                  ...
                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" font-style="italic" space-after="4mm">
                    If <fo:inline font-weight="bold"> "Yes" </fo:inline> to 30 b or c above, complete the <fo:inline font-weight="bold"> CLAIM SUPPLEMENT </fo:inline> for each claim or potential claim.
                  </fo:block>
                      ...
                      <fo:table-body>
                        <fo:table-row>
                          ...
                          <fo:table-cell border-bottom="0.9pt solid black" display-align="after">
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                              &#160;
                                <xsl:value-of select="response/firm_freeform_01/data/ContactPerson"></xsl:value-of>
                            </fo:block>
                          </fo:table-cell>
                          <fo:table-cell display-align="after">
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="left" space-after="4mm">
                        ...
                        <fo:table-row>
                          ...
                          <fo:table-cell border-bottom="0.9pt solid black" display-align="after">
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                              &#160;
                                <xsl:value-of select="response/policy_freeform_01/data/WorkPhone"></xsl:value-of>
                            </fo:block>
                          </fo:table-cell>
                          <fo:table-cell display-align="after">
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="left" space-after="4mm">
                          ...
                          <fo:table-cell border-bottom="0.9pt solid black" display-align="after">
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="left" space-after="4mm">
                             <xsl:value-of select="response/policy_freeform_01/data/otherPhone"/> &#160;
                        ...
                        <fo:table-row>
                          ...
                          <fo:table-cell border-bottom="0.9pt solid black" display-align="after">
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                              &#160;
                                <xsl:value-of select="response/policy_freeform_01/data/AccountEmail"></xsl:value-of>
                            </fo:block>
                          </fo:table-cell>
                          <fo:table-cell display-align="after">
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="left" space-after="4mm">
                              Secondary Email:
                                <xsl:value-of select="response/firm_freeform_01/data/secondaryEmail"></xsl:value-of>
                            </fo:block>
                          </fo:table-cell>
                          <fo:table-cell border-bottom="0.9pt solid black" display-align="after">
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="left" space-after="4mm">
                             <xsl:value-of select="response/policy_freeform_01/data/secondaryEmail"/> &#160;
                            </fo:block>
                          </fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                          ...
                          <fo:table-cell border-bottom="0.9pt solid black" display-align="after" number-columns-spanned="3">
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                              &#160;
                                <xsl:value-of select="response/firm_freeform_01/data/Website"></xsl:value-of>
                            </fo:block>
                          </fo:table-cell>                          
                        </fo:table-row>
                      </fo:table-body>
          ...
          <fo:block page-break-before="always"/>
		<xsl:if test="response/firm_freeform_01/data/IsFirmCoverageForPreceedorFirms = 'Y'">
