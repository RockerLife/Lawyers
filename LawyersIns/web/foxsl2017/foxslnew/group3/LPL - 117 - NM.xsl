...
<xsl:stylesheet version="1.1"
	...
	xmlns:java="java">
  <xsl:template match="/" name="LPL-117-NM">
          <fo:block>				  	
          ...
          <fo:block padding-left="5pt" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" font-size="10px" text-align="justify">
            ...
            <fo:block space-after="4mm">
           and notwithstanding anything to the contrary in the New Mexico Amendatory Endorsement, LPL-AMEND-NM1 or LPL-AMEND-NM2, it is agreed that: </fo:block>
                ...
                <fo:list-item space-after="4mm">
                  ...
                  <fo:list-item-body>
                    ...
                    <fo:block space-after="3mm" start-indent="7mm">
                     1.	Item 4. of the Declarations, Deductible, is deleted and replaced with the following:                 </fo:block>
                      <fo:block>
                  ...
                  <fo:list-item-body start-indent="15mm">
                    <fo:block space-after="3mm" start-indent="7mm">
                      <fo:block space-after="3mm">
                       2.	Section II. of the policy, Limits of Liability and Deductible, subsection B., Deductible, is deleted and replaced with the following </fo:block>
                      <fo:block space-after="3mm">
             <fo:block >Solely for policies with an "each <fo:inline font-weight="bold">Claim"</fo:inline> Limit of Liability below $500,000:</fo:block>
                      ...
                      <fo:block start-indent="13mm">
                        ...
                        <fo:block margin-top="3mm"></fo:block>
                        <fo:block>Solely for policies with an "each <fo:inline font-weight="bold">Claim</fo:inline>" Limit of Liability of $500,000 and above:
 ...
 <fo:block start-indent="20mm">
			...
			<fo:block  font-size="10px" color="grey" text-align="left">LPL-117 (04/17) NM<!--<xsl:value-of select="response/policyformfooter_freeform_01/data/LPL1170417NJ"/> -->
