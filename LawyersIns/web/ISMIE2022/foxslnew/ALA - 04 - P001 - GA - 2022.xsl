...
<xsl:stylesheet version="1.1"
	...
	<xsl:template name="Policycoverletter1_GA" match="/">
		...
		<fo:block margin-top="1.5cm"></fo:block>
			  ...
			  <fo:block  font-size="10px" color="grey" text-align="left">ISMIE ALA-04-P001 (03/01/2022)
		...
		<fo:block break-after="page"></fo:block>
          ...
          <fo:block font-size="10px" text-align="left" start-indent="2cm">
           ...
           <fo:block font-size="10px" text-align="left" start-indent="1.5cm">
            ...
            <fo:block font-size="10px" text-align="left" start-indent="2cm">
                  (b) specific information as to the expected negligent act, error, omission, <fo:inline font-weight="bold">Personal Injury</fo:inline> or <fo:inline font-weight="bold">Advertising Liability</fo:inline>;
            </fo:block>
            <fo:block font-size="10px" text-align="left" start-indent="2cm">
