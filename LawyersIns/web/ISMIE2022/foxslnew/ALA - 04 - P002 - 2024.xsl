...
<xsl:stylesheet version="1.1"
	...
	<xsl:template name="Policycoverletter0_group5" match="/" >
                ...
                <xsl:choose>
					<xsl:when test="response/policy_freeform_01/data/StateCode= 'OK'">
						<fo:block font-weight="normal" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" margin-top="2mm" font-size="10px" text-align="left">                 
                 	...
                 	<xsl:when test="response/policy_freeform_01/data/StateCode= 'ND'">
                 		<fo:block font-weight="bold" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" margin-top="2mm" font-size="10px" text-align="left">
					...
					<xsl:otherwise>
						<fo:block font-weight="normal" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" margin-top="2mm" font-size="11px" text-align="left">                 
                 		NOTICE: THIS IS A CLAIMS MADE AND REPORTED POLICY. EXCEPT AS OTHERWISE PROVIDED HEREIN, THIS POLICY PROVIDES COVERAGE FOR <fo:inline font-weight="bold" >CLAIMS</fo:inline> FIRST MADE AGAINST THE <fo:inline font-weight="bold" >INSURED</fo:inline> AND REPORTED TO THE <fo:inline font-weight="bold" >INSURER</fo:inline> DURING THE <fo:inline font-weight="bold" >POLICY PERIOD</fo:inline> OR DURING ANY APPLICABLE EXTENDED REPORTING PERIOD. PLEASE READ THIS POLICY CAREFULLY. WORDS AND PHRASES WHICH ARE PRINTED IN <fo:inline font-weight="bold" >BOLD TYPEFACE</fo:inline> HAVE SPECIFIC MEANING AND ARE DEFINED IN SECTION IV. OF THE POLICY.  UNLESS STATED OTHERWISE BY SPECIFIC ENDORSEMENT, <fo:inline font-weight="bold" >DEFENSE EXPENSES</fo:inline> ARE INCLUDED IN THE LIMIT OF LIABILITY AND REDUCE THE LIMIT OF LIABILITY AVAILABLE TO PAY <fo:inline font-weight="bold" >DAMAGES</fo:inline>.</fo:block>
					</xsl:otherwise>
				</xsl:choose> 	
				...
				<fo:block margin-top="1mm" font-size="10px" text-align="left">
					<fo:inline font-weight="bold" >TO REPORT A LOSS -    InsClaim Solutions, LLC 300 S. Wacker Dr., 32nd FL Chicago, Illinois 60606
					</fo:inline> 
				</fo:block>
			 ...
			 <fo:block margin-top="5mm" font-size="10px" color="grey" text-align="left">ISMIE ALA-04-P002 (08/01/2024)
