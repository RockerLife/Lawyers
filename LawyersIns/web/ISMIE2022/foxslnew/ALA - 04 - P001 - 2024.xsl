...
<xsl:stylesheet version="1.1"
	...
	<xsl:template name="Policycoverletter_group5" match="/">
		...
		<fo:block margin-top="1.5cm"></fo:block>
			  ...
			  <fo:block  font-size="10px" color="grey" text-align="left">ISMIE ALA-04-P001 (08/01/2024)
		...
		<fo:block font-size="10px" start-indent="2cm" text-align="left">
			(2)	the Optional Extended Reporting Period cannot be cancelled by the <fo:inline font-weight="bold">Insured</fo:inline> or the <fo:inline font-weight="bold">Insurer</fo:inline>.
		</fo:block>
		<fo:block margin-top="2mm" />
		<fo:block font-size="10px" start-indent="2cm" text-align="left">
		...
		<fo:block font-size="10px" start-indent="2.5cm" text-align="left">
			...
			Reporting Period cannot be cancelled by the <fo:inline font-weight="bold">Insured</fo:inline> or the <fo:inline font-weight="bold">Insurer</fo:inline>.
		</fo:block>
		<fo:block margin-top="2mm" />
		...
		<fo:block font-size="10px" start-indent="2cm" text-align="left">
			(b)	the <fo:inline font-weight="bold">Insured</fo:inline> must be in compliance with the terms and conditions of the policy;
		</fo:block>
		<fo:block font-size="10px" start-indent="2cm" text-align="left">
		...
		<fo:block margin-top="2mm" />
		<fo:block font-weight="bold" text-indent="1cm" font-size="12px"
			text-align="left">E.	Deductible Credit</fo:block>
		<fo:block margin-top="2mm" />
		<fo:block font-size="10px" start-indent="1.5cm" text-align="left">
			If: 
		</fo:block>
		<fo:block font-size="10px" start-indent="1.5cm" text-align="left">
			1.	mediation of a <fo:inline font-weight="bold">Claim</fo:inline> takes place either without institution of an arbitration proceeding or service of suit within 365 days of the institution of such proceedings or service of suit; and such <fo:inline font-weight="bold">Claim</fo:inline> is ultimately resolved for an amount acceptable to the <fo:inline font-weight="bold">Insured</fo:inline> and the <fo:inline font-weight="bold">Insurer</fo:inline> by the process of mediation, or
		</fo:block>
		
		<fo:block font-size="10px" start-indent="1.5cm" text-align="left">
			2.	The <fo:inline font-weight="bold">Named Insured</fo:inline> has been continuously insured by the <fo:inline font-weight="bold">Insurer</fo:inline> for a minimum of three (3) full consecutive policy periods and the <fo:inline font-weight="bold">Named Insured</fo:inline> has not reported any <fo:inline font-weight="bold">Claims</fo:inline> in the last three policy periods
		</fo:block>
		<fo:block font-size="10px" start-indent="1.5cm" text-align="left">
			the <fo:inline font-weight="bold">Insured’s Deductible</fo:inline> applying to the <fo:inline font-weight="bold">Claim</fo:inline> will be reduced by the lesser of 50% or $25,000.
		</fo:block>
		<fo:block margin-top="2mm" />
		<fo:block font-weight="bold" text-indent="1cm" font-size="12px"
		...
		<fo:block margin-top="2mm" />
		<fo:block font-size="10px" start-indent="1.5cm" text-align="left">
			The <fo:inline font-weight="bold">Insurer</fo:inline> will reimburse an <fo:inline font-weight="bold">Insured</fo:inline> $1,000 per day for the time such <fo:inline font-weight="bold">Insured</fo:inline> attends a: 
		</fo:block>
		<fo:block font-size="10px" start-indent="1.5cm" text-align="left">
			1.	trial;
		</fo:block>
		...
		<fo:block font-size="10px" start-indent="1.5cm" text-align="left">
			...
			inquiries first initiated against the <fo:inline font-weight="bold">Insured</fo:inline> and reported to the
		...
		<fo:block margin-top="2mm" />
		<fo:block font-size="10px" start-indent="1.5cm" text-align="left">
			The <fo:inline font-weight="bold">Insurer</fo:inline> will reimburse the <fo:inline font-weight="bold">Named Insured</fo:inline> up to $50,000 for each <fo:inline font-weight="bold">Insured</fo:inline>, for attorney fees and other reasonable
			...
			during the <fo:inline font-weight="bold">Policy Period</fo:inline> and reported to the <fo:inline font-weight="bold">Insurer</fo:inline> during the <fo:inline font-weight="bold">Policy Period</fo:inline>, and arising out of an act, error or omission in the rendering
			...
			Acts Date</fo:inline>. The amount payable hereunder shall not exceed $100,000
		...
		<fo:block margin-top="2mm" />
		<fo:block font-size="10px" start-indent="1.5cm" text-align="left">
			The <fo:inline font-weight="bold">Insurer</fo:inline> will reimburse the <fo:inline font-weight="bold">Named Insured</fo:inline> up to $50,000 for <fo:inline font-weight="bold">
		...
		<fo:block break-after="page"></fo:block>
				 ...
				 <fo:block>
                  ...
                  <fo:list-item-body>
                    <fo:block start-indent="1.5cm">
					   ...
					   <fo:block start-indent="1.5cm" >actual or alleged negligent acts, errors or omissions asserted by or on behalf of one or more <fo:inline font-weight="bold">Insureds</fo:inline> against any other <fo:inline font-weight="bold" >Insured</fo:inline>.</fo:block>
          ...
          <fo:block font-size="10px" text-align="left" start-indent="2cm">
           ...
           <fo:block font-size="10px" text-align="left" start-indent="1.5cm">
            ...
            <fo:block font-size="10px" text-align="left" start-indent="2cm">
                  (b) specific information as to the expected negligent act, error, omission, <fo:inline font-weight="bold">Personal Injury</fo:inline> or <fo:inline font-weight="bold">Advertising</fo:inline>
            </fo:block> 
            <fo:block font-size="10px" text-align="left" start-indent="2.5cm"><fo:inline font-weight="bold">Liability</fo:inline>;
            </fo:block>
            <fo:block font-size="10px" text-align="left" start-indent="2cm">
            ...
            <fo:block font-size="10px" text-align="left" start-indent="2cm">
                ...
                <fo:block font-size="10px" text-align="left" start-indent="2cm">then any <fo:inline font-weight="bold">Claim</fo:inline> or coverage under this policy arising out of such specific facts or circumstances that is subsequently made against the <fo:inline font-weight="bold">Insured</fo:inline> and reported to the <fo:inline font-weight="bold">Insurer</fo:inline> shall be deemed first made during the <fo:inline font-weight="bold">Policy Period</fo:inline> as of the date of such notice.</fo:block>
 ...
 -->
            ...
            <fo:block font-size="10px" text-align="left" start-indent="1cm">
                  3.&#160;&#160;&#160;&#160;&#160;Notice of a <fo:inline font-weight="bold">Claim or potential Claim</fo:inline> to the Insurer shall be given in writing to:
            </fo:block>
            <fo:block margin-top="2mm" />

            <fo:block font-size="10px" font-weight="bold" text-align="left" text-indent="2cm">Attention: InsClaim Solutions, LLC</fo:block>
            <fo:block font-size="10px" font-weight="bold" text-align="left" text-indent="2cm">300 S. Wacker Dr., 32nd FL</fo:block>
            <fo:block font-size="10px" font-weight="bold" text-align="left" text-indent="2cm">Chicago, Illinois 60606</fo:block>
            <fo:block font-size="10px" font-weight="bold" text-align="left" text-indent="2cm">Email: claims@ins-claim.com</fo:block>
            ...
            <fo:block margin-top="2mm" />
				...
				<fo:block font-size="10px" text-align="left" start-indent="2cm">are groundless, false, or fraudulent. In undertaking this right and duty, the<fo:inline font-weight="bold" > Insurer</fo:inline> expressly retains the right to select defense counsel even when the<fo:inline font-weight="bold" > Insurer</fo:inline> reserves its rights on issues concerning the applicability of coverage under this policy. The<fo:inline font-weight="bold" > Insured </fo:inline>shall pay any <fo:inline font-weight="bold" >Defense Expenses</fo:inline> within the applicable Deductible shown in Item 4. of the Declarations. The<fo:inline font-weight="bold" > Insurer’s</fo:inline> right and duty to defend any <fo:inline font-weight="bold" >Claim</fo:inline> and pay <fo:inline font-weight="bold" >Defense Expenses</fo:inline> shall terminate upon the exhaustion of the Limit of Liability, whereupon the <fo:inline font-weight="bold" >Insurer</fo:inline> shall have no further obligation or liability to defend the<fo:inline font-weight="bold" > Insured</fo:inline> or to pay <fo:inline font-weight="bold" >Defense Expenses</fo:inline>, judgments or settlements.  The <fo:inline font-weight="bold" >Insurer </fo:inline>may make any investigation it deems necessary and may, with the <fo:inline font-weight="bold" >Insured’s</fo:inline> consent, such consent not to be unreasonably withheld, make any settlement of any <fo:inline font-weight="bold" >Claim</fo:inline> it deems expedient.</fo:block>
				<fo:block margin-top="2mm"/>
				<fo:block font-size="10px" text-align="left" start-indent="1.5cm">2.	The <fo:inline font-weight="bold" >Insured </fo:inline>and those acting on behalf of the <fo:inline font-weight="bold" > Insured</fo:inline> shall not admit liability, consent to any judgment,</fo:block>
				<fo:block font-size="10px" text-align="left" start-indent="2cm">incur any <fo:inline font-weight="bold" >Defense Expenses</fo:inline> or agree to any settlement without the<fo:inline font-weight="bold" > Insurer’s</fo:inline> written consent, such consent not to be unreasonably withheld.  The <fo:inline font-weight="bold" >Insured</fo:inline> agrees that they shall not knowingly take any action that in any way increases<fo:inline font-weight="bold" > Damages</fo:inline> or<fo:inline font-weight="bold" > Defense Expenses</fo:inline> under this policy.  Coverage afforded by this policy shall not apply to any <fo:inline font-weight="bold" >Damages</fo:inline> sustained as a result of any admission of liability or consent to any judgment or agreement to settle, without or prior to the<fo:inline font-weight="bold" > Insurer’s</fo:inline> written consent.</fo:block>
				
				<fo:block margin-top="2mm"/>
				<fo:block font-size="10px" text-align="left" start-indent="1.5cm">3.	The<fo:inline font-weight="bold" > Insured</fo:inline> shall provide the<fo:inline font-weight="bold" > Insurer</fo:inline> with such information, assistance, and cooperation as the <fo:inline font-weight="bold" >Insurer</fo:inline></fo:block>
				...
				<fo:block margin-top="2mm"/>
				<fo:block font-size="10px" text-align="left" start-indent="1.5cm">1.&#160;	No action shall be taken against the <fo:inline font-weight="bold" >Insurer</fo:inline> unless, as a condition precedent thereto, the <fo:inline font-weight="bold" >Insured</fo:inline> shall </fo:block>
				<fo:block font-size="10px" text-align="left" start-indent="2cm">have fully complied with all of the terms and conditions of this policy, nor until the amount of the <fo:inline font-weight="bold" >Insured’s</fo:inline> obligation to pay <fo:inline font-weight="bold" >Damages</fo:inline> for any <fo:inline font-weight="bold" >Claim</fo:inline> shall have been fully and finally determined either by judgment against the <fo:inline font-weight="bold" >Insured</fo:inline> or by written agreement between the <fo:inline font-weight="bold" >Insured</fo:inline>, the claimant, and the <fo:inline font-weight="bold" >Insurer</fo:inline>.</fo:block>
				<fo:block margin-top="2mm"/>
				...
				<fo:block font-size="10px" text-align="left" start-indent="2cm">against the <fo:inline font-weight="bold" >Insured</fo:inline> to determine their liability. Nor shall the <fo:inline font-weight="bold" >Insurer</fo:inline> be impleaded by the <fo:inline font-weight="bold" >Insured</fo:inline> or the <fo:inline font-weight="bold" >Insured's</fo:inline> legal representative in any <fo:inline font-weight="bold" >Claim</fo:inline>.</fo:block>
				<fo:block margin-top="2mm"/>
