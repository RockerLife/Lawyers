...
<xsl:stylesheet version="1.1"
	...
	<xsl:template name="Policycoverletter1_CA" match="/">
		...
		<fo:block margin-top="1.5cm"></fo:block>
			  ...
			  <fo:block  font-size="10px" color="grey" text-align="left">ISMIE ALA-04-P001 (02/01/2024)
		...
		<fo:block font-size="10px" start-indent="1.5cm" text-align="left">
			1. mediation of a <fo:inline font-weight="bold">Claim</fo:inline> takes place either without institution of  
  			an arbitration proceeding or service of suit within 365 days of the institution of such proceedings or 
  			service of suit; and such <fo:inline font-weight="bold">Claim</fo:inline>
			is ultimately resolved for an amount acceptable to the <fo:inline font-weight="bold">Insured</fo:inline> 
			and the <fo:inline font-weight="bold">Insurer</fo:inline> by the process of mediation, or
		</fo:block>
		<fo:block font-size="10px" start-indent="1.5cm" text-align="left">
			2. The <fo:inline font-weight="bold">Named Insured</fo:inline> has been continuously insured by the 
			<fo:inline font-weight="bold">Insurer</fo:inline> for a minimum of three (3) full consecutive 
			policy periods and the <fo:inline font-weight="bold">Named Insured</fo:inline> has not reported any 
			<fo:inline font-weight="bold">Claims</fo:inline> in the last three policy periods 
		</fo:block>
		<fo:block font-size="10px" start-indent="1.5cm" text-align="left">
		...
		<fo:block margin-top="2mm" />
		<fo:block font-size="10px" start-indent="1.5cm" text-align="left">
			The <fo:inline font-weight="bold">Insurer</fo:inline> will reimburse the <fo:inline font-weight="bold">Named Insured</fo:inline> up to $50,000 for each <fo:inline font-weight="bold">Insured</fo:inline>, 
			for attorney fees and other reasonable costs, expenses or fees paid to third parties (other than an <fo:inline font-weight="bold">Insured</fo:inline>)
 ...
 -->
            ...
            <fo:block font-size="10px" text-align="left" text-indent="2cm" font-weight="bold">Attention: InsClaim Solutions, LLC</fo:block>
            <fo:block font-size="10px" text-align="left" text-indent="2cm" font-weight="bold">300 S. Wacker Dr., 32nd FL</fo:block>
            <fo:block font-size="10px" text-align="left" text-indent="2cm" font-weight="bold">Chicago, IL 60606</fo:block>
            <fo:block font-size="10px" text-align="left" text-indent="2cm" font-weight="bold">Email: claims@ins-claim.com</fo:block>
            ...
            <fo:block margin-top="2mm" />
				...
				<fo:block font-size="10px" text-align="left" start-indent="2cm">are groundless, false, or fraudulent. In undertaking this right and duty, the<fo:inline font-weight="bold" > Insurer</fo:inline> expressly retains the right to select defense counsel even when the<fo:inline font-weight="bold" > Insurer</fo:inline> reserves its rights on issues concerning the applicability of coverage under this policy. The<fo:inline font-weight="bold" > Insureds </fo:inline>shall pay any <fo:inline font-weight="bold" >Defense Expenses</fo:inline> within the applicable Deductible shown in Item 4. of the Declarations. The<fo:inline font-weight="bold" > Insurer’s</fo:inline> right and duty to defend any <fo:inline font-weight="bold" >Claim</fo:inline> and pay <fo:inline font-weight="bold" >Defense Expenses</fo:inline> shall terminate upon the exhaustion of the Limit of Liability, whereupon the <fo:inline font-weight="bold" >Insurer</fo:inline> shall have no further obligation or liability to defend the<fo:inline font-weight="bold" > Insured</fo:inline> or to pay <fo:inline font-weight="bold" >Defense Expenses</fo:inline>, judgments or settlements.  The <fo:inline font-weight="bold" >Insurer </fo:inline>may make any investigation it deems necessary and may, with the <fo:inline font-weight="bold" >Insured’s</fo:inline> consent, such consent not to be unreasonably withheld, make any settlement of any <fo:inline font-weight="bold" >Claim</fo:inline> it deems expedient. If the <fo:inline font-weight="bold" >Insured</fo:inline> withholds consent of such settlement, the <fo:inline font-weight="bold" >Insurer’s </fo:inline>liability for all <fo:inline font-weight="bold" >Damages</fo:inline> on account of such <fo:inline font-weight="bold" >Claim</fo:inline> shall not exceed the amount for which the<fo:inline font-weight="bold" > Insurer</fo:inline> could have settled such<fo:inline font-weight="bold" > Claim</fo:inline>, inclusive of <fo:inline font-weight="bold" >Defense Expenses</fo:inline>, incurred as of the date such settlement was proposed to the<fo:inline font-weight="bold" > Insured</fo:inline>
																				plus 50% of any additional damages inclusive of <fo:inline font-weight="bold" >Defense Expenses</fo:inline> incurred after the <fo:inline font-weight="bold" >Insured’s</fo:inline> refusal to settle</fo:block>
				<fo:block margin-top="2mm"/>
