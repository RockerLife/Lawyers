...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/" name="ALA04F009_MA">
					<fo:block>				  	
				     ...
				     <fo:block margin-top="4mm"/>
				     <fo:block  font-size="10px"> In  consideration  of  the  premium  charged, it is agreed that Item 6. of the Declarations, <fo:inline font-weight="bold" >Prior Acts Date</fo:inline>, is amended to include the date shown in Column B below with respect to the <fo:inline font-weight="bold" >Predecessor Firm</fo:inline> shown in Column A below:</fo:block>
				 	 <fo:block margin-top="10mm"/>
				 ...
				 <fo:block  font-size="10px" color="grey" text-align="left">ISMIE ALA-04-F009 MA (09/01/2022)
