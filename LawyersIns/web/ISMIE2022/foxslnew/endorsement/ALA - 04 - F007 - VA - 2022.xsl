...
<xsl:stylesheet version="1.1"
  ...
  <xsl:template match="/" name="ALA04F007_VA">
						...
						<fo:table border="2pt solid black" text-align="center">
							...
							<fo:table-body>
								<fo:table-row>
									...
									<fo:table-cell border="2pt solid black"	padding-bottom="4mm" padding-left="4pt">
										<fo:block font-size="10px" text-align="left">Endorsement Number: ISMIE ALA-04-F007 (09/01/2021)</fo:block>
									</fo:table-cell>
								</fo:table-row>
							</fo:table-body>	
						</fo:table>
               ...
               In consideration of: (check one box only)
                 ...
                 <!--  <fo:block start-indent="4mm" space-after="8mm">
                  ...
                  <fo:block>
					...
					<fo:block  font-size="10px" color="grey" text-align="left">ISMIE ALA-04-F007VA (06/01/2022)
