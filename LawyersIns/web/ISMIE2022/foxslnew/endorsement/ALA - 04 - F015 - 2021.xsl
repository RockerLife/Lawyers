...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/" name="F015">
					<fo:block>				  	
				     ...
				     <fo:block text-align="left" font-size="10px" >In consideration of the premium charged, it is agreed that Endorsement # ALA-04-F015 effective <xsl:value-of select="response/endorsement_freeform_01/data/TransactionEffectiveDate" /> of this policy is hereby deleted, null and void.</fo:block>
					    		  ...
					    		  <fo:table-cell>
					                    <xsl:choose>
					                    	<xsl:when test="response/isShowSignature='Y'">
				                   		  ...
				                   		  <fo:table-cell  padding-left="250pt" padding-top="4pt"><fo:block   text-align="center"><xsl:value-of select="response/general_freeform_01/data/CurrentDate"/></fo:block></fo:table-cell>
					    		  </fo:table-row>
					    		 <fo:table-row>
					    		  		<fo:table-cell padding-left="4pt" padding-top="4pt">
					               		...
					               		<fo:table-cell padding-left="250pt"  padding-top="4pt">
					               			 <fo:block  font-size="10px"  text-align="center">________________________</fo:block>
					               		</fo:table-cell>
					             </fo:table-row>
					    		   <fo:table-row>
