...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/" name="ALAF041">
						...
						<fo:table border="2pt solid black" text-align="center">
							...
							<fo:table-body>
								<fo:table-row>
									...
									<fo:table-cell border="2pt solid black"	padding-bottom="4mm" padding-left="4pt">
									 	<fo:block font-size="10px" text-align="left">Endorsement Number: ISMIE ALA-04-F041 (03/01/2022)</fo:block>
										<fo:block>&#160;</fo:block>
				...
				<fo:block margin-top="10mm"/> 
		         ...
		         <fo:block  font-size="10px" color="grey" text-align="left">ISMIE ALA-04-F041 (03/01/2022)
