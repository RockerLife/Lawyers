...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/" name="Policycoverletter3">
						...
						<fo:table border="2pt solid black" text-align="center">
							...
							<fo:table-body>
								<fo:table-row>
									...
									<fo:table-cell border="2pt solid black"	padding-bottom="4mm" padding-left="4pt">
										<fo:block font-size="10px" text-align="left">Endorsement Number: ISMIE ALA-04-F005 (09/01/2021)</fo:block>
									</fo:table-cell>
								</fo:table-row>
							</fo:table-body>	
						</fo:table>
				...
				<fo:block margin-top="8mm"/>
		        <fo:block  font-size="10px" color="grey" text-align="left">ISMIE ALA-04-F005 (09/01/2021)
