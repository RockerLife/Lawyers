...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/" name="Policycoverletter18006">
					...
					<fo:block margin-top="2mm">
				     ...
				     <fo:block text-align="left" font-size="10px" >it is agreed that Endorsement #LPL-104 (04/17) of this policy hereby deleted.</fo:block>
