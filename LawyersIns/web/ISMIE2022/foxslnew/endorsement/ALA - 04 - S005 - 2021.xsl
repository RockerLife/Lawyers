...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/" name="S005">
					    		  ...
					    		  <fo:table-row>
					                    ...
					                    <xsl:choose>
					                    	<xsl:when test="response/isShowSignature='Y'">
				                   		  ...
				                   		  <fo:table-cell padding-top="2pt" padding-left="250pt"><fo:block   text-align="center"><xsl:value-of select="response/general_freeform_01/data/CurrentDate"/></fo:block></fo:table-cell>
					    		  </fo:table-row>
					    		 <fo:table-row>
	        	...
	        	<fo:block  font-size="10px" color="grey" text-align="left">ISMIE ALA-04-S005 (09/01/2021)
