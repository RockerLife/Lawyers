...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/" name="Policycoverletter2">
                     ...
                     <fo:table border="2pt solid black">
						...
						<fo:table-body>
							<fo:table-row>
								...
								<fo:table-cell border="2pt solid black"	padding-bottom="4mm" padding-left="4pt">
									<fo:block text-align="left" font-size="10px" ><fo:inline font-weight="bold" >Limit of Liability:</fo:inline></fo:block>
				      ...
				      <fo:block text-align="left" font-size="10px" text-indent="0.4cm" font-weight="bold" >A. Limits of Liability</fo:block>
				       <fo:block margin-top="2mm"/>
				            ...
				            <fo:block text-align="justify" font-size="10px" start-indent="0.8cm">1.	 Subject to 2. that follows, the <fo:inline font-weight="bold" >Insurer's</fo:inline> Limits of Liability for <fo:inline font-weight="bold" >Damages</fo:inline> and <fo:inline font-weight="bold" >Defense Expenses</fo:inline>, for each</fo:block>
				     		<fo:block text-align="justify" font-size="10px" start-indent="1.2cm"> <fo:inline font-weight="bold" >Claim</fo:inline> first made and reported to the <fo:inline font-weight="bold" >Insurer</fo:inline> during the <fo:inline font-weight="bold" >Policy Period</fo:inline>, including any applicable Extended Reporting Period, shall not exceed the amounts shown in Item 3. of the Declarations as applicable to <fo:inline font-weight="bold" >"Damages</fo:inline>,each<fo:inline font-weight="bold" > Claim"</fo:inline> and <fo:inline font-weight="bold" >"Defense Expenses</fo:inline>, each <fo:inline font-weight="bold" >Claim"</fo:inline>, respectively.</fo:block>
				        
				           <fo:block text-align="justify" font-size="10px" start-indent="0.8cm" >2.	Subject to 1. above, the <fo:inline font-weight="bold" >Insurer's</fo:inline>  Limits of Liability for <fo:inline font-weight="bold" >Damages</fo:inline> and <fo:inline font-weight="bold" >Defense Expenses</fo:inline>, for all <fo:inline font-weight="bold" >Claims</fo:inline>  first </fo:block>
				     
				          <fo:block text-align="justify" font-size="10px" start-indent="1.2cm">made and reported to the <fo:inline font-weight="bold" >Insurer</fo:inline> during the <fo:inline font-weight="bold" >Policy Period</fo:inline>, including any applicable Extended Reporting Period, shall not exceed the amounts shown in Item 3. of the Declarations as applicable to <fo:inline font-weight="bold" >"Damages Aggregate"</fo:inline> and <fo:inline font-weight="bold" >"Defense Expenses Aggregate"</fo:inline>, respectively.</fo:block>
				        
				           <fo:block text-align="justify" font-size="10px" start-indent="0.8cm" >3.	The Limits of Liability shall apply excess of the Deductible amount.</fo:block>
				     
				        
				           <fo:block text-align="justify" font-size="10px" start-indent="0.8cm" >4.	The Limits of Liability available for <fo:inline font-weight="bold" >Claims</fo:inline> first made against the <fo:inline font-weight="bold" >Insured</fo:inline> and reported to the <fo:inline font-weight="bold" >Insurer</fo:inline> during </fo:block>
				           <fo:block text-align="justify" font-size="10px" start-indent="1.2cm">any applicable Extended Reporting Period, are part of, and not in addition to the Limits of Liability shown in Item 3. of the Declarations. Applicable Extended Reporting Periods shall not provide any new, additional or renewed Limit of Liability.</fo:block>
				     
				           <fo:block text-align="justify" font-size="10px" start-indent="0.8cm" >5.	If the <fo:inline font-weight="bold" >Insurer</fo:inline> has exhausted the <fo:inline font-weight="bold" >"Damages</fo:inline>, each <fo:inline font-weight="bold" >Claim"</fo:inline> Limit of Liability by payment of <fo:inline font-weight="bold" >Damages</fo:inline> or by </fo:block>
				           <fo:block text-align="justify" font-size="10px" start-indent="1.2cm">tender of the remaining <fo:inline font-weight="bold" >"Damages</fo:inline>, each <fo:inline font-weight="bold" >Claim"</fo:inline> Limit of Liability into court, it shall have no further duties to the <fo:inline font-weight="bold" >Insured</fo:inline> under this policy with respect to the same <fo:inline font-weight="bold" >Claim</fo:inline>.</fo:block>
				     
				           <fo:block text-align="justify" font-size="10px" start-indent="0.8cm" >6.	If the <fo:inline font-weight="bold" >Insurer</fo:inline> has exhausted the <fo:inline font-weight="bold" >"Damages Aggregate"</fo:inline> Limit of Liability by payment of <fo:inline font-weight="bold" >Damages</fo:inline> or by </fo:block>
				           <fo:block text-align="justify" font-size="10px" start-indent="1.2cm">tender of the remaining <fo:inline font-weight="bold" >"Damages Aggregate"</fo:inline> Limit of Liability into court, it shall have no further duties to the <fo:inline font-weight="bold" >Insured</fo:inline> under this policy with respect to all <fo:inline font-weight="bold" >Claims</fo:inline>.</fo:block>
				   ...
				   <fo:block  font-size="10px" color="grey" text-align="left">ISMIE ALA-04-F004 (09/01/2021)
		        	 <fo:block margin-top="-0.5cm" font-size="10px" color="grey" text-align="right">Page 1 of 2</fo:block>
				      ...
				      <fo:block margin-top="8mm"/>
				        ...
				        <fo:block text-align="justify" font-size="10px" start-indent="0.8cm" >In the event the amount shown in this endorsement for <fo:inline font-weight="bold" >Defense Expenses</fo:inline>, each <fo:inline font-weight="bold" >Claim</fo:inline> is exhausted, then 
				      ...
				      <fo:block text-align="justify" font-size="10px" start-indent="1cm">Declarations as applicable to "each <fo:inline font-weight="bold" >Claim"</fo:inline>, to <fo:inline font-weight="bold" >"Damages Aggregate"</fo:inline> and to <fo:inline font-weight="bold" >"Defense Expenses Aggregate"</fo:inline> shall be subject to paragraph A. of this Section II. If <fo:inline font-weight="bold" >Related Claims</fo:inline> are subsequently made against the <fo:inline font-weight="bold" >Insured</fo:inline> and reported to the <fo:inline font-weight="bold" >Insurer,</fo:inline> all such <fo:inline font-weight="bold" >Related Claims</fo:inline>, whenever made, shall be considered a single <fo:inline font-weight="bold" >Claim</fo:inline> first made and reported to the <fo:inline font-weight="bold" >Insurer</fo:inline> within the policy period in which the earliest of the <fo:inline font-weight="bold" >Related Claims</fo:inline> was first made and reported to the <fo:inline font-weight="bold" >Insurer</fo:inline>.</fo:block>
				       ...
				       <fo:block margin-top="2mm"/>
				        ...
				        <fo:block text-align="justify" font-size="10px" start-indent="1.7cm">the maximum amount of the <fo:inline font-weight="bold" >Insurer's</fo:inline> liability for all <fo:inline font-weight="bold" >Damages</fo:inline> for all <fo:inline font-weight="bold" >Claims</fo:inline> under this policy, inclusive of any applicable Extended Reporting Period.</fo:block>
				       <fo:block margin-top="2mm"/>
				        ...
				        <fo:block text-align="justify" font-size="10px" start-indent="1.7cm">represents the maximum amount of the <fo:inline font-weight="bold" >Insurer's</fo:inline> liability for all <fo:inline font-weight="bold" >Defense Expenses</fo:inline> for all <fo:inline font-weight="bold" >Claims</fo:inline> under this policy, inclusive of any applicable Extended Reporting Period.</fo:block>
				      
				      
				        
				        
				        
				        <!-- <fo:block text-align="left" text-indent="0.5cm" font-size="10px" >a.  The word “combined” is deleted where it appears in paragraph 1. and 2.;</fo:block>
				        <fo:block text-align="left" text-indent="0.5cm" font-size="10px" >b.  Paragraph 3. is deleted in its entirety;</fo:block> 
				        <fo:block margin-top="4mm"/>
				        ...
				        <fo:block margin-top="4mm"/>
				        <fo:block text-align="left" start-indent="0.5cm" font-size="10px" >In the event the amount shown above for  <fo:inline font-weight="bold" >Defense Expenses</fo:inline>, each  <fo:inline font-weight="bold" >Claim</fo:inline> is exhausted, then  <fo:inline font-weight="bold" >Defense Expenses</fo:inline>
               incurred thereafter, shall be part of and reduce the Limit of Liability as shown for  <fo:inline font-weight="bold" >Damages</fo:inline>, each  <fo:inline font-weight="bold" >Claim</fo:inline>.  In the 
               event the amount shown above for  <fo:inline font-weight="bold" >Defense Expenses Policy Aggregate</fo:inline> is exhausted, then  <fo:inline font-weight="bold" >Defense Expenses</fo:inline>
               incurred thereafter, shall be part of and reduce the Limit of Liability as shown for  <fo:inline font-weight="bold" >Damages Policy Aggregate</fo:inline>.
				        </fo:block> -->
