...
<xsl:stylesheet version="1.1"
    ...
    <fo:leader leader-pattern="rule" />
				     ...
				     <fo:block text-align="left"  font-size="10px">(b)	is deemed by a court of competent jurisdiction to be a partner, officer, director, employee, associate, manager or </fo:block>
		       ...
		       <!--<fo:block  font-size="10px" color="grey" text-align="left"><xsl:value-of select="response/policyformfooter_freeform_01/data/LPL1060417" /></fo:block>
			    -->
			      ...
			      <fo:block  font-size="10px" color="grey" text-align="left">ISMIE ALA-04-F008 (09/01/2021)
