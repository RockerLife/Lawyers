			...
			<fo:page-sequence master-reference="A4-portrait">
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:table text-align="center">
						...
						<fo:table-body>
								...
								<fo:table-cell padding-left="4pt">
									<fo:block font-weight="bold" font-size="10px"
										text-align="left">Transaction:
											<xsl:choose>
				                            <xsl:when test="response/InvoiceDataLW/data/PolicyStatusKey = 1">
				                            New Policy
				                            </xsl:when>
				                            <xsl:when test="response/InvoiceDataLW/data/PolicyStatusKey = 2">
				                            Renewal Policy
				                            </xsl:when>
							...
							<fo:table-row>
								<fo:table-cell padding-left="4pt" padding-top="4pt">
									<fo:block font-weight="bold" font-size="10px"
										text-align="left">Carrier: ISMIE Mutual Insurance Company
									</fo:block>
								</fo:table-cell>
								<fo:table-cell padding-left="4pt" padding-top="4pt">
									<fo:block font-weight="bold" font-size="10px"
					...
					<fo:block font-size="10px" text-indent="1.8cm" color="grey"
						text-align="center">Payment Due – <xsl:value-of select="response/InvoiceDataLW/data/PayementDueDate" /> </fo:block>
				</fo:flow>
			</fo:page-sequence>
		</fo:root>
	</xsl:template>
