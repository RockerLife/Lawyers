...
<xsl:stylesheet version="1.1"
      ...
      <fo:page-sequence master-reference="A4-portrait">
                ...
                <fo:table-cell>
                  ...
                  <!--   <xsl:choose>
                      <xsl:when test="response/policy_freeform_01/data/StateCode= 'FL'">
                        <fo:block text-align="left" font-size="8px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" color="grey">  LPL FL – 101 (09/10) </fo:block>
                      </xsl:when>
                      ...
                      <xsl:when test="response/policy_freeform_01/data/StateCode= 'NH'">
                        <fo:block text-align="left" font-size="8px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" color="grey">  LPL – NH - 101 (09/10) </fo:block>
                      </xsl:when>
                      <xsl:when test="response/policy_freeform_01/data/StateCode= 'IA'">
                        <fo:block text-align="left" font-size="8px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" color="grey">  LPL – IA - 101 (09/10) </fo:block>
                      </xsl:when>
                      <xsl:otherwise>
                        <fo:block text-align="left" font-size="8px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" color="grey"> LPL – 101 (04/17)</fo:block>
                      </xsl:otherwise>
                    </xsl:choose> -->
                    	<xsl:choose>
				<xsl:when test="response/policy_freeform_01/data/StateCode= 'FL'">
					<fo:block text-align="left" font-size="8px" font-family="Arial" color="grey">  LPL FL – 131 (08/13)</fo:block>	
				</xsl:when>
				<xsl:when test="response/policy_freeform_01/data/StateCode= 'CT'">
					<fo:block text-align="left" font-size="8px" font-family="Arial" color="grey">  LPL CT - 131 (08-13)</fo:block>	
				</xsl:when>
				<xsl:when test="response/policy_freeform_01/data/StateCode= 'NH'">
					<fo:block text-align="left" font-size="8px" font-family="Arial" color="grey">  LPL NH - 131 (08-13)</fo:block>	
				</xsl:when>
				<xsl:when test="response/policy_freeform_01/data/StateCode= 'IA'">
					<fo:block text-align="left" font-size="8px" font-family="Arial" color="grey">  LPL IA – 131 (08/13)</fo:block>	
				</xsl:when>
				<xsl:otherwise>
					<fo:block text-align="left" font-size="8px" font-family="Arial" color="grey"> LPL – 131 (08/13)</fo:block>	
				</xsl:otherwise>
				</xsl:choose>
                  </fo:block>
                </fo:table-cell>
        ...
        <fo:flow flow-name="xsl-region-body">
          ...
          <fo:block  font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="justify"  space-after="4mm">
            NOTICE: COVERAGE FOR WHICH THIS APPLICATION IS MADE IS WRITTEN ON A CLAIMS MADE AND REPORTED BASIS MEANING, EXCEPT AS OTHERWISE PROVIDED, COVERAGE APPLIES ONLY TO <fo:inline> CLAIMS </fo:inline> FIRST MADE AGAINST THE <fo:inline> INSURED </fo:inline> AND REPORTED TO THE <fo:inline> INSURER </fo:inline> DURING THE POLICY PERIOD OR DURING ANY APPLICABLE EXTENDED REPORTING PERIOD.
        </fo:block>
          <fo:block  font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="justify"  space-after="4mm">
                    ...
                    <fo:table border="0.9pt solid white">
                      ...
                      <fo:table-body>
                        <fo:table-row>
                          <fo:table-cell>
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="justify" space-after="4mm">
                              3.&#160;&#160;  Has the distribution of your Areas of Practice changed?
                            </fo:block>
                          </fo:table-cell>
                          <fo:table-cell text-align="right">
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">
 ...
 <fo:block break-after="page"/>
          ...
          <xsl:otherwise>
					<fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="justify" space-after="4mm" margin-top="10px" margin-bottom="10px">
            <fo:inline font-weight="bold">FRAUD WARNING: </fo:inline>ANY PERSON WHO KNOWINGLY PRESENTS A FALSE OR FRAUDULENT CLAIM FOR PAYMENT OF A LOSS OR BENEFIT OR KNOWINGLY PRESENTS FALSE INFORMATION IN AN APPLICATION FOR INSURANCE IS GUILTY OF A CRIME AND MAY BE SUBJECT TO FINES AND CONFINEMENT IN PRISON.
            (Not applicable in CO, FL, KS, KY, ME, MD, NJ, NY, OH, OK, OR, PA, TN, VT, VA and WA).
		...
		<xsl:if test="response/isBankruptcyPage='Y'">
            ...
            <fo:table border="0.9pt solid black">
              ...
              <fo:table-body>
                <fo:table-row>
                  <fo:table-cell border="0.9pt solid black" background-color="LightGray">
                    <fo:block margin-top="1mm" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" font-weight="bold" font-size="10px">
                      BANKRUPTCY SUPPLEMENT  <fo:inline font-style="italic">(as required in Question 3, Area of Practice Table)</fo:inline>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-body>
          ...
          <fo:block>
            <fo:list-block provisional-distance-between-starts="0.8cm" provisional-label-separation="0.15cm">
                  ...
                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm">
                    ...
                    <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm">
                      <fo:table border="0.9pt solid white">
                        ...
                        <fo:table-column column-width="0.8in"/>
                        <fo:table-column column-width="1.6in"/>
                        <fo:table-column column-width="O.8in"/>
                        <fo:table-column column-width="1.8in"/>
                        <fo:table-column column-width="0.8in"/>
                        <fo:table-body>
                          <fo:table-row>
              ...
              <fo:list-item padding-top="10px">
                ...
                <fo:list-item-body start-indent="7mm">
                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm">
                  	In the past year how many bankruptcy cases has the firm handled each year in the following categories:
                                     </fo:block>
                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm">
                    <fo:table border="0.9pt solid black">
                      <fo:table-column column-width="1.8in"/>
                      ...
                      <fo:table-body>
                        ...
                        <fo:table-row>
                          <fo:table-cell  border="0.9pt solid black" display-align="after" padding-left="3px">
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="center">
                              Last Completed Year:
                            </fo:block>
                          </fo:table-cell>
		...
		<xsl:if test="response/isCollectionPage='Y'">
		<fo:block page-break-after="always"></fo:block>
          ...
          <xsl:if test="response/isCopyrightPage='Y'">
          <fo:block page-break-after="always"></fo:block>
            ...
            <fo:table border="0.9pt solid black">
              ...
              <fo:table-body>
                <fo:table-row>
                  <fo:table-cell border="0.9pt solid black" background-color="LightGray">
                    <fo:block margin-top="1mm" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" font-weight="bold" font-size="10px">
                      CORPORATE / COMMERCIAL / BUSINESS SUPPLEMENT  <fo:inline font-style="italic">(as required in Question 3, Area of Practice Table)</fo:inline>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-body>
		 ...
		 <!--  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="justify" space-after="4mm" start-indent="4mm">
          ...
          <xsl:if test="response/isFamilyLawPage='Y'">
          <fo:block page-break-after="always"></fo:block>
          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" margin-top="20px" margin-bottom="20px">
            <fo:table border="0.9pt solid black">
              <fo:table-column/>
         ...
         <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="left" space-after="4mm" start-indent="7mm">
          ...
          <xsl:if test="response/isFinancialPage='Y'">
          <fo:block page-break-after="always"></fo:block>
          ...
          <xsl:if test="response/isGovermentPage='Y'">
          <fo:block page-break-after="always"></fo:block>
		...
		<xsl:if test="response/isLitigationPage='Y'">
		<fo:block page-break-after="always"></fo:block>
          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" margin-top="20px" margin-bottom="20px">
            <fo:table border="0.9pt solid black">
              <fo:table-column/>
                      ...
                      <fo:table-body>
                        <fo:table-row>
                          ...
                          <fo:table-cell text-align="center" border="0.9pt solid black">
                            <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" start-indent="2mm" margin-right="2mm" font-weight="bold" text-align="center">
	...
	<xsl:if test="response/isRealestatePage='Y'">
	<fo:block page-break-after="always"></fo:block>
          ...
          <xsl:if test="response/isTaxPage='Y'">
     <fo:block page-break-after="always"></fo:block>
          ...
          <xsl:if test="response/isWillsTrustPage='Y'">
          <fo:block page-break-after="always"></fo:block>
            ...
            <fo:table border="0.9pt solid black">
              ...
              <fo:table-body>
                <fo:table-row>
                  <fo:table-cell border="0.9pt solid black" background-color="LightGray">
                    <fo:block margin-top="1mm" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" font-weight="bold" font-size="10px">
                      TRUSTS, WILLS, ESTATE, PROBATE SUPPLEMENT <fo:inline font-style="italic">(as required in Question 3, Area of Practice Table)</fo:inline>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-body>
          ...
          <fo:block space-after="4mm">
            <fo:list-block provisional-distance-between-starts="0.8cm" provisional-label-separation="0.15cm">
              ...
              <fo:list-item margin-top="10px">
                ...
                <fo:list-item-body start-indent="7mm">
                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="left">
                    If applicable, please complete below for the three largest trusts for which you provide services:
                  </fo:block>
                  <fo:block  space-after="4mm">
                    <fo:leader leader-pattern="rule" leader-length="100%" rule-style="solid" rule-thickness="0.2px"/>
                  </fo:block>
                </fo:list-item-body>
              </fo:list-item>
            ...
            <fo:table border="0.9pt solid white">
              ...
              <fo:table-body>
                ...
                <fo:table-row>
                  ...
                  <fo:table-cell text-align="right" border="0.9pt solid black" padding="2px">
                    <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="left">
          ...
          <fo:block font-size="8px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="left" start-indent="7mm" space-after="4mm">
