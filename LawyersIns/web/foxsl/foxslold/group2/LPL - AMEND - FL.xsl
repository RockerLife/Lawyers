...
<xsl:stylesheet version="1.1"
				        ...
				        <fo:table-body>
					    		  ...
					    		  <fo:table-row>
					               		...
					               		<fo:table-cell padding-left="4pt"  padding-top="4pt">
					               			 <fo:block font-weight="bold" font-size="10px"  text-align="left">Endorsement No: <xsl:value-of select="response/endorsements_freeform_01/data/LPLAMENDFL0910" /></fo:block>
					               		</fo:table-cell>
					    		  </fo:table-row>
   ...
   <fo:block space-after=".1in" text-align-last="justify">
    <fo:leader leader-pattern="rule" />
				     ...
				     <fo:block text-align="center" font-weight="bold" font-size="10px">FLORIDA AMENDATORY ENDORSEMENT</fo:block>
				     <fo:block margin-top="10mm"/>
				
				    <fo:block text-align="left" font-size="10px"> Section III., Extensions of Coverage, paragraph B. Spousal and Domestic Partner Extension is deleted and replaced with the following:</fo:block>
					<fo:block margin-top="8mm"/>
				 	<fo:block text-align="left" font-weight="bold" font-size="10px">B. Spousal And Domestic Partner Extension </fo:block>
				 	<fo:block margin-top="4mm"/>
				 	<fo:block text-align="left" font-size="10px">If a <fo:inline font-weight="bold" font-style="italic">Claim</fo:inline> is made against the lawful spouse of an <fo:inline font-weight="bold" font-style="italic">Insured</fo:inline> which includes a <fo:inline font-weight="bold" font-style="italic">Claim</fo:inline> for a negligent act, error or omission made against an <fo:inline font-weight="bold" font-style="italic">Insured</fo:inline> rendering <fo:inline font-weight="bold" font-style="italic">Professional Services</fo:inline> then such <fo:inline font-weight="bold" font-style="italic">Claim</fo:inline> shall be deemed a <fo:inline font-weight="bold" font-style="italic">Claim</fo:inline> made against such <fo:inline font-weight="bold" font-style="italic">Insured</fo:inline>, provided his or her lawful spouse accepts the same legal counsel as the <fo:inline font-weight="bold" font-style="italic">Insured</fo:inline> and that such <fo:inline font-weight="bold" font-style="italic">Claim</fo:inline> is made solely by reason of such lawful spouse’s status as such. This extension, however, shall not apply to any <fo:inline font-weight="bold" font-style="italic">Claim</fo:inline> alleging any negligent act, error or omission committed by the lawful spouse.</fo:block>
				 	<!-- 
				 	<fo:block margin-top="4mm"/>				 	
			  ...
			  <fo:block margin-top="10mm"/>
			  <fo:block  font-size="10px"  start-indent="2cm" color="grey" text-align="left"><xsl:value-of select="response/policyformfooter_freeform_01/data/LPLAMENDFL0910" /></fo:block>
