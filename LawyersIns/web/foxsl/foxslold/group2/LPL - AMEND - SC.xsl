...
<xsl:stylesheet version="1.1"
				        ...
				        <fo:table-body>
					    		  ...
					    		  <fo:table-row>
					               		...
					               		<fo:table-cell padding-left="4pt"  padding-top="4pt">
					               			 <fo:block font-weight="bold" font-size="10px"  text-align="left">Endorsement No: <xsl:value-of select="response/endorsements_freeform_01/data/LPLAMENDSC0910" /></fo:block>
					               		</fo:table-cell>
					    		  </fo:table-row>
   ...
   <fo:block space-after=".1in" text-align-last="justify">
    <fo:leader leader-pattern="rule" />
				     ...
				     <fo:block text-align="center" font-weight="bold" font-size="10px">SOUTH CAROLINA AMENDATORY ENDORSEMENT </fo:block>
				     <fo:block margin-top="10mm"/>
					...
					<fo:block margin-top="4mm"/>
				 	...
				 	<fo:block text-align="left" start-indent="2cm" font-size="10px">3. This policy may be non-renewed by the <fo:inline font-weight="bold" font-style="italic">Insurer</fo:inline> by delivering to the <fo:inline font-weight="bold" font-style="italic">Named Insured</fo:inline> or by mailing to the first
                   <fo:inline font-weight="bold" font-style="italic">Named Insured</fo:inline> at its last known address, and to its agent, written notice of such nonrenewal and the precise 
                   reason for it, at least ninety days prior to the expiration of the <fo:inline font-weight="bold" font-style="italic">Policy Period</fo:inline>  if the <fo:inline font-weight="bold" font-style="italic">policy period</fo:inline> is on year or less, or 
                   the anniversary date of the policy if written for a period longer than one year or with an indefinite term. The proof of 
                   mailing of such notice shall be sufficient proof of such notice.
					</fo:block>
					<fo:block margin-top="2mm"/>
					<fo:block text-align="left" start-indent="2cm" font-size="10px">However, the <fo:inline font-weight="bold" font-style="italic">Insurer</fo:inline> will not refuse to renew a policy issued for a term of more than one year until the expiration of 
                  	 its full term, if anniversary renewal has been guaranteed by additional premium consideration. 
					</fo:block>
			  ...
			  <fo:block margin-top="10mm"/>
			  <fo:block  font-size="10px"  start-indent="2cm" color="grey" text-align="left"><xsl:value-of select="response/policyformfooter_freeform_01/data/LPLAMENDSC0910" /></fo:block>
