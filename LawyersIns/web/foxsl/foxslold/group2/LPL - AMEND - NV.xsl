...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/" name="LPL-AMEND-NV">
								...
								<fo:table-row>
									...
									<fo:table-cell padding-left="4pt" padding-top="4pt">
										<fo:block font-weight="bold" font-size="10px"
											...
											Endorsement No:
											<xsl:value-of
												select="response/endorsements_freeform_01/data/LPLAMENDNV0910" />
										</fo:block>
									</fo:table-cell>
								</fo:table-row>
					...
					<fo:block text-align="center" font-weight="bold"
						font-size="10px">NEVADA AMENDATORY ENDORSEMENT</fo:block>
					<fo:block margin-top="10mm" />
					...
					<fo:block text-align="left" font-size="10px">
						It is agreed that
						Section VI., General Conditions, D. Cancellation and Nonrenewal,
						paragraph 2. is amended by deletion of the second sentence and
						replacing the second sentence with the following sentence:
					</fo:block>

					<fo:block margin-top="4mm" />
					<fo:block start-indent="1.5cm" text-align="left"
						font-size="10px">
						This policy may be canceled by or on behalf of the
						<fo:inline font-weight="bold" font-style="italic">Insurer</fo:inline> by
						delivering to the <fo:inline font-weight="bold" font-style="italic">Named Insured</fo:inline>, or by mailing to the
						<fo:inline font-weight="bold" font-style="italic">Named Insured</fo:inline>, at the address shown in Item 1. of the
						Declarations,
						written notice of such cancellation at least thirty
						(30)
					...
					<fo:block text-align="left" font-size="10px">
						...
						that Section VI., General Conditions, D. Cancellation and
						Nonrenewal, paragraph 3. is amended by deletion of the phrase “…
						at least thirty days prior…” where it appears in the first
						sentence and replacing such phrase with the following:
					...
					<fo:block font-size="10px" start-indent="2cm" color="grey"
						text-align="left">
						<xsl:value-of
							select="response/policyformfooter_freeform_01/data/LPLAMENDNV0910" />
