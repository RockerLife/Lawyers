...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/" name="LPL-AMEND-IA" >
				        ...
				        <fo:table-body>
					    		  ...
					    		  <fo:table-row>
					               		...
					               		<fo:table-cell padding-left="4pt"  padding-top="4pt">
					               			 <fo:block font-weight="bold" font-size="10px"  text-align="left">Endorsement No: <xsl:value-of select="response/endorsements_freeform_01/data/LPLAMENDIA0910" /></fo:block>
					               		</fo:table-cell>
					    		  </fo:table-row>
   ...
   <fo:block space-after=".1in" text-align-last="justify">
    <fo:leader leader-pattern="rule" />
				     ...
				     <fo:block text-align="center" font-weight="bold" font-size="10px">IOWA AMENDATORY ENDORSEMENT</fo:block>
				     <fo:block margin-top="10mm"/>
                   ...
                   <fo:inline font-weight="bold" font-style="italic">Named  Insured</fo:inline> at its last known address,  written notice of such nonrenewal at least forty five days prior to the 
                   ...
                   shall not apply, however, if the <fo:inline font-weight="bold" font-style="italic">Insurer</fo:inline> has offered to issue a renewal policy or, if non renewal is due to the failure of
                   the <fo:inline font-weight="bold" font-style="italic">Named Insured</fo:inline> to pay any advance premium required for renewal of this policy.
</fo:block>
				 	 <!--
			  ...
			  <fo:block margin-top="10mm"/>
			  <fo:block  font-size="10px"  start-indent="2cm" color="grey" text-align="left"><xsl:value-of select="response/policyformfooter_freeform_01/data/LPLAMENDIA0910" /></fo:block>
