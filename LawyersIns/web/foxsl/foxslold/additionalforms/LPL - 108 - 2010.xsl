...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/" name="LPL1082010">
				    ...
				    <fo:block space-after=".1in" text-align-last="justify">
				     ...
				     <fo:block margin-top="10mm"/>
				    <fo:block  font-size="10px">It is agreed that Section IV, DEFINITIONS, definition of <fo:inline font-weight="bold" font-style="italic"> Insured</fo:inline> is amended to add the following paragraph:</fo:block>
				 	 <fo:block margin-top="10mm"/>
				 	 <fo:block  font-size="10px" text-align="center">However, <fo:inline font-weight="bold" font-style="italic">Insured</fo:inline> shall not include the following person (s) or entity (ies) or any entity that is operated, managed or owned by such person(s) or entity (ies), or any affiliate, subsidiary or parent of such person(s) or entity (ies):</fo:block>
						<fo:block margin-top="10mm"/>
	         	...
	         	<fo:block  font-size="10px" text-indent="2cm" color="grey" text-align="left"><xsl:value-of select="response/policyformfooter_freeform_01/data/LPL1080910"/></fo:block>
