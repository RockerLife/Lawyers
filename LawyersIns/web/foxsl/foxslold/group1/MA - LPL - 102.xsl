...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/" name="MADefenceExpensesInAddition">
				        ...
				        <fo:table-body>
					    		  ...
					    		  <fo:table-row>
					               		...
					               		<fo:table-cell padding-left="4pt"  padding-top="4pt">
					               			 <fo:block font-weight="bold" font-size="10px"  text-align="left">Endorsement No: <xsl:value-of select="response/endorsements_freeform_01/data/LPL1020910MAUSF" /></fo:block>
					               		</fo:table-cell>
					    		  </fo:table-row>
    ...
    <fo:leader leader-pattern="rule" />
               ...
               incurred thereafter, shall be part of and reduce the Limit of Liability as shown for  <fo:inline font-weight="bold" font-style="italic">Damages Policy Aggregate</fo:inline>.
	         	...
	         	<fo:block  font-size="10px" text-indent="2cm" color="grey" text-align="left"><xsl:value-of select="response/policyformfooter_freeform_01/data/LPL1020910MAUSF"/></fo:block>
