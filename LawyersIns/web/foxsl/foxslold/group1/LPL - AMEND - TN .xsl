...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/" name="LPL-State-TN" >
	<!--  
	<fo:root>		
				        ...
				        <fo:table-body>
					    		  ...
					    		  <fo:table-row>
					               		...
					               		<fo:table-cell padding-left="4pt"  padding-top="4pt">
					               			 <fo:block font-weight="bold" font-size="10px"  text-align="left">Endorsement No: <xsl:value-of select="response/endorsements_freeform_01/data/LPLAMENDTN0910" /></fo:block>
					               		</fo:table-cell>
					    		  </fo:table-row>
   ...
   <fo:block space-after=".1in" text-align-last="justify">
    <fo:leader leader-pattern="rule" />
				     ...
				     <fo:block text-align="center" font-weight="bold" font-size="10px" >TENNESSEE AMENDATORY ENDORSEMENT</fo:block>
                  ...
                  <fo:inline font-weight="bold" font-style="italic"> Named Insured </fo:inline>at its last known address, and to its agent, written notice of such nonrenewal at least sixty days prior 
                   		to the expiration of the <fo:inline font-weight="bold" font-style="italic">Policy Period</fo:inline>. The proof of mailing of such notice shall be sufficient proof of such notice.
                   		Such notice is not required if the <fo:inline font-weight="bold" font-style="italic">Insurer</fo:inline> has offered a renewal policy or if the<fo:inline font-weight="bold" font-style="italic"> Named Insured</fo:inline> has obtained 
			  ...
			  <fo:block  font-size="10px"  text-indent="2cm" color="grey" text-align="left"><xsl:value-of select="response/policyformfooter_freeform_01/data/LPLAMENDTN0910" /></fo:block>
		  <!--  
		    </fo:flow>
		  </fo:page-sequence>
		</fo:root>	  
