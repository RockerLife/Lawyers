...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/" name="LPLFORM129">
				        ...
				        <fo:table-body>
					    		  ...
					    		  <fo:table-row>
					               		...
					               		<fo:table-cell padding-left="4pt"  padding-top="4pt">
					               			 <fo:block font-weight="bold" font-size="10px"  text-align="left">Endorsement No: <xsl:value-of select="response/endorsements_freeform_01/data/LPL1290813" /></fo:block>
					               		</fo:table-cell>
					    		  </fo:table-row>
				    ...
				    <fo:block space-after=".1in" text-align-last="justify">
				     ...
				     <fo:block text-align="center" font-weight="bold" font-size="10px">AMEND EXCLUSION D. ENDORSEMENT</fo:block>
				     
				     <fo:block margin-top="10mm"/>
				    
				     <fo:block text-align="left"  font-size="10px">In consideration of premium charged, it is understood and agreed that <fo:inline font-weight="bold" font-style="italic">Section V. Exclusions, D.</fo:inline> is deleted and replaced with the following:</fo:block>
				     <fo:block margin-top="6mm"/>
				     <fo:block text-align="left" font-size="10px" start-indent="2cm">This policy does not apply to any <fo:inline font-weight="bold" font-style="italic">Claim</fo:inline> based upon or arising out of:</fo:block>
				     <fo:block margin-top="6mm"/>
				     <fo:block text-align="left" font-size="10px" start-indent="2cm"><fo:inline font-weight="bold" font-style="italic">D.</fo:inline>	any actual or alleged (a) false, deceptive or unfair trade practice; (b) violation of consumer protection laws; or (c) false, deceptive or misleading trade practices.  However, the <fo:inline font-weight="bold" font-style="italic">Insurer</fo:inline> will provide the <fo:inline font-weight="bold" font-style="italic">Insured</fo:inline> with a defense of such <fo:inline font-weight="bold" font-style="italic">Claim</fo:inline> and pay <fo:inline font-weight="bold" font-style="italic">Defense Expenses</fo:inline>, which are subject to the Deductible, if any.</fo:block>
	         	...
	         	<fo:block  font-size="10px" text-indent="2cm" color="grey" text-align="left"><xsl:value-of select="response/policyformfooter_freeform_01/data/LPL1290813"/></fo:block>
