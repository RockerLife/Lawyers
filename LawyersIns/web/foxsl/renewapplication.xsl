...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/">
		...
		<fo:root>
			...
			<fo:flow flow-name="xsl-region-body">
				...
				<fo:block>
					<fo:table margin-top="3mm">
						...
						<fo:table-body>
					    	...
					    	<fo:table-row>
					        	<fo:table-cell><fo:block  font-size="12px" font-family="Arial Black" font-weight="bold" text-align="center"> LAWYERS PROFESSIONAL LIABILITY RENEWAL APPLICATION</fo:block></fo:table-cell>
					        </fo:table-row>
					    </fo:table-body>
					</fo:table>
				</fo:block>	
				<fo:block>
					...
					<fo:table>
						...
						<fo:table-body>
							<fo:table-row>
								<fo:table-cell border="0.0pt solid black"><fo:block font-style="italic" font-family="Tahoma" font-size="7px">
							<xsl:choose>							
					        		<xsl:when test="response/policy_freeform_01/data/StateCode= 'CT'">					        			
				...
				<!--  Policy Effective Date Commented				
				 <fo:block>
				...
				<fo:block>
					<fo:table margin-top="3mm" border="0.0pt solid black">  
						...
						<fo:table-body>       
					        <fo:table-row>
					        	<fo:table-cell><fo:block font-size="9px" font-family="Arial">2. </fo:block></fo:table-cell>
					        	<fo:table-cell><fo:block font-size="9px" font-family="Arial"> Please update the list below with those attorneys whose status has changed in the past year, or any attorneys that have left the firm or have joined the firm:</fo:block></fo:table-cell>					        	
					        </fo:table-row>
					    </fo:table-body>
					</fo:table> 
						...
						<xsl:when test="response/firm_freeform_01/data/IsFirmPracticeInOtherState = 'Y'">
							<fo:table margin-top="3mm" border="0.0pt solid black">  
								...
								<fo:table-body>
								    <fo:table-row>
								    	<fo:table-cell><fo:block font-size="9px" font-family="Arial">3.</fo:block></fo:table-cell>
							        	<fo:table-cell><fo:block font-size="9px" font-family="Arial">Does the Applicant have additional offices other than the principal location indicated in question 1 that have been added since the last application?</fo:block></fo:table-cell>
							...
							<fo:table margin-top="3mm" border="0.0pt solid black">  
								...
								<fo:table-body>
								    <fo:table-row> 
								    	<fo:table-cell><fo:block font-size="9px" font-family="Arial"></fo:block></fo:table-cell>
								    	<fo:table-cell><fo:block font-size="9px" font-family="Arial">b.</fo:block></fo:table-cell>
							        	<fo:table-cell><fo:block font-size="9px" font-family="Arial">Do any of these additional offices listed in 3.a. above operate under a different legal name than provided in Question 1?</fo:block></fo:table-cell>
							        	<fo:table-cell><fo:block font-size="9px" font-family="Arial" text-align="right">Yes <fo:external-graphic src="../LawyersIns/image/check-btn6.png"/>&#160;&#160;&#160;No <fo:external-graphic src="../LawyersIns/image/check-btn4.png"/></fo:block></fo:table-cell>
							        </fo:table-row>
							    </fo:table-body>
							</fo:table>
					...
					<fo:table margin-top="3mm" border="0.0pt solid black">  
						...
						<fo:table-body>       
					        <fo:table-row>
					        	...
					        	<fo:table-cell><fo:block font-size="9px" font-family="Arial">Gross fees billed by the Applicant in the last fiscal year: </fo:block></fo:table-cell>
					        	<fo:table-cell><fo:block font-size="9px" font-family="Arial"><xsl:value-of select="response/firm_freeform_01/data/GrossFeesPaidRenewAmount"/></fo:block></fo:table-cell>
					        </fo:table-row>
					    </fo:table-body>
					</fo:table>  
				</fo:block>	
				
				<!-- Applicant provide legal service as clients 
							...
							<fo:table margin-top="3mm" border="0.0pt solid black">  
								...
								<fo:table-body>
								    <fo:table-row>
					        				...
					        				<fo:table-cell><fo:block font-size="9px" font-family="Arial">At any time in the past year, has the Applicant or any attorney of the Applicant (regardless of what firm the attorney was employed by at such time) provided legal services related to mass tort/class action, securities transactions, investment vehicles or ventures, hedge or other investment funds, money or investment management or investments with clients? </fo:block></fo:table-cell>
					        				<fo:table-cell><fo:block font-size="9px" font-family="Arial" text-align="right">Yes <fo:external-graphic src="../LawyersIns/image/check-btn6.png"/>&#160;&#160;&#160;No <fo:external-graphic src="../LawyersIns/image/check-btn4.png"/></fo:block></fo:table-cell>
					       			 </fo:table-row>
							    </fo:table-body>
							</fo:table>
					...
					<fo:block>
							...
							<xsl:when test="response/firm_freeform_01/data/IsFirmHaveClientMoreThan25PercentOfBilling = 'Y'">
								<fo:table margin-top="3mm" border="0.0pt solid black">  
									...
									<fo:table-body>
										<fo:table-row>
									    	<fo:table-cell><fo:block font-size="9px" font-family="Arial">8.</fo:block></fo:table-cell>
								        	<fo:table-cell><fo:block font-size="9px" font-family="Arial">At any time during the last year has any client of the Applicant represented more than 30% of the Applicant’s annual revenue?</fo:block></fo:table-cell>
								        	<fo:table-cell><fo:block font-size="9px" font-family="Arial" text-align="right">Yes&#160;<fo:external-graphic src="../LawyersIns/image/check-btn6.png"/>&#160;&#160;&#160;No&#160;<fo:external-graphic src="../LawyersIns/image/check-btn4.png"/></fo:block></fo:table-cell>
								        </fo:table-row>
								    </fo:table-body>
								</fo:table> 
						...
						<fo:table margin-top="1mm" border="0.0pt solid black">  
							...
							<fo:table-body>
								<fo:table-row>
							    	<fo:table-cell><fo:block font-size="9px" font-family="Arial">a.</fo:block></fo:table-cell>
							    	<fo:table-cell><fo:block font-size="9px" font-family="Arial">If Yes, please indicate percentage of revenue from largest revenue client (include client’s affiliated entities): ____<xsl:value-of select="response/firm_freeform_01/data/PercentFromFirstLargestRevenueClient"/>% </fo:block></fo:table-cell>
						        </fo:table-row>
							</fo:table-body>
						</fo:table>					
						<fo:table>
										...
										<fo:block>
											<fo:table margin-top="1mm" border="0.5pt solid black">  
												...
												<fo:table-body>       
											        ...
											        <fo:table-row>
											        	<fo:table-cell border="0.5pt solid black"><fo:block font-size="9px" font-family="Arial" text-align="center" font-weight="bold">Date Rendered</fo:block></fo:table-cell>
						...
						<fo:table margin-top="1mm" border="0.0pt solid black">  
							...
							<fo:table-body>
								<fo:table-row>
							    	<fo:table-cell><fo:block font-size="9px" font-family="Arial">b.</fo:block></fo:table-cell>
							    	<fo:table-cell><fo:block font-size="9px" font-family="Arial">Please indicate percentage of revenue from second largest revenue client (include client’s affiliated entities):____<xsl:value-of select="response/firm_freeform_01/data/PercentFromSecondLargestRevenueClient"/>%</fo:block></fo:table-cell>
						        </fo:table-row>
							</fo:table-body>
						</fo:table>					
						<fo:table>
								...
								<fo:table margin-top="3mm" border="0.0pt solid black">  
									...
									<fo:table-body>
										<fo:table-row>
								        	...
								        	<fo:table-cell><fo:block font-size="9px" font-family="Arial">In the last year has the Applicant initiated lawsuits or arbitration procedures to enforce the collection of unpaid fees of any client?</fo:block></fo:table-cell>
								        	<fo:table-cell><fo:block font-size="9px" font-family="Arial" text-align="right">Yes&#160;<fo:external-graphic src="../LawyersIns/image/check-btn6.png"/>&#160;&#160;&#160;No&#160;<fo:external-graphic src="../LawyersIns/image/check-btn4.png"/></fo:block></fo:table-cell>
								        </fo:table-row>
								    </fo:table-body>
								</fo:table> 
					...
					<fo:block>
						<fo:table margin-top="3mm" border="0.0pt solid black">  
							...
							<fo:table-body>
								<fo:table-row>
						        	...
						        	<fo:table-cell><fo:block font-size="9px" font-family="Arial">After inquiry of all attorneys and staff of the Applicant, within the past year  have any past or present personnel:</fo:block></fo:table-cell>
						        </fo:table-row>
							</fo:table-body>
						</fo:table>
						<xsl:choose>
						...
						<fo:table margin-top="3mm" border="0.0pt solid black">  
							...
							<fo:table-body>
								<fo:table-row>
							    	<fo:table-cell><fo:block font-size="9px" font-family="Arial"></fo:block></fo:table-cell>
						        	<fo:table-cell><fo:block font-size="9px" font-family="Arial" font-weight="bold">NOTE: THE POLICY FOR WHICH THIS APPLICATION IS BEING MADE SHALL NOT APPLY TO ANY INCIDENTS OR CLAIMS DETAILED OR WHICH SHOULD HAVE BEEN DETAILED IN THE QUESTION 10 a, b or c ABOVE.</fo:block></fo:table-cell>
						        </fo:table-row>
							</fo:table-body>
						</fo:table>
						<fo:table margin-top="3mm" border="0.0pt solid black">  
							...
							<fo:table-body>
								<fo:table-row>
							    	<fo:table-cell><fo:block font-size="9px" font-family="Arial"></fo:block></fo:table-cell>
						        	<fo:table-cell><fo:block font-size="9px" font-family="Arial">If "<fo:inline font-weight="bold" font-style="italic">Yes</fo:inline>" to 10 b or c above, complete the <fo:inline font-weight="bold" font-style="italic">CLAIM SUPPLEMENT</fo:inline> for each claim or potential claim</fo:block></fo:table-cell>
						        </fo:table-row>
							</fo:table-body>
						</fo:table>
					</fo:block>	
            ...
            <fo:block font-size="10px" font-family="Arial" space-after="4mm" padding-top="62px">
              ...
              <fo:table-body>
                ...
                <fo:table-row>
                  <fo:table-cell display-align="after" number-columns-spanned="4" padding-top="7px" padding-bottom="15px">
                    <fo:block font-size="9px" font-family="Arial" text-align="left" space-after="4mm">
