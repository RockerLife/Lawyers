...
<xsl:stylesheet version="1.1"
	...
	xmlns:java="java">
      ...
      <xsl:include  href="foxslnew/Signature2021.xsl" />
      ...
      <xsl:include  href="foxslnew/group2/MI-40-009-02-20-TX.xsl" />
      ...
      <xsl:include  href="foxslnew/group7/MI_40_007_04_19_FL.xsl" />
		    ...
		    <fo:page-sequence master-reference="A4-portrait">		
				...
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:block>
						...
						<!-- <xsl:call-template name="Signature" />
						<fo:block break-after="page" />	 -->
						<xsl:call-template name="Signature2021" />
						<fo:block break-after="page" />	
						...
						<xsl:if test="response/address_freeform_01/data/StateCode= 'TX'">
							...
							<xsl:call-template name="LPL-AMEND-TX-COMPLAINT-NEW1" />
							<fo:block break-after="page" /> 
						</xsl:if>
						...
						<xsl:if test="response/address_freeform_01/data/StateCode= 'FL'">
							...
							<fo:block break-after="page" />
							<xsl:call-template name="MI_40_007_04_19_FL" />
							<fo:block break-after="page" />
						</xsl:if>
