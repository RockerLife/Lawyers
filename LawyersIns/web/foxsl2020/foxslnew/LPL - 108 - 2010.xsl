			   ...
			   <fo:block space-after=".1in" text-align-last="justify">
    				<fo:leader leader-pattern="rule" />
				     ...
				     <fo:block margin-top="5mm"/>	      
				      ...
				      <fo:block text-align="left" text-indent="2cm" font-size="10px" >If during the  <fo:inline font-weight="bold" >Policy Period</fo:inline> , the <fo:inline font-weight="bold" > Insurer </fo:inline>adopts any provision that would broaden the coverage under this</fo:block>
				      ...
				      <fo:block text-align="left" font-size="10px" >(2) Section IV., Definitions, definition of <fo:inline font-weight="bold" >Insured</fo:inline> is deleted and replaced with the following definition:</fo:block>
				      <fo:block margin-top="5mm"/>
				      <fo:block text-align="left" font-size="10px" text-indent="1.5cm" ><fo:inline font-weight="bold" >Insured</fo:inline> means the <fo:inline font-weight="bold" >Named Insured</fo:inline>, <fo:inline font-weight="bold" >Predecessor Firm</fo:inline>, and:</fo:block>
				      <fo:block margin-top="5mm"/>
				      <fo:block text-align="left" font-size="10px" start-indent="2.5cm" >(a)  any present or future principal, partner, director, officer, member or employee of the <fo:inline font-weight="bold" >Named Insured</fo:inline> ;</fo:block> 
				      <fo:block text-align="left" font-size="10px" start-indent="2.5cm" >(b)  any former principal, partner, director, officer, member or employee of the <fo:inline font-weight="bold" >Named Insured</fo:inline> or of a </fo:block> 
				      <fo:block text-align="left" font-size="10px" start-indent="3cm" ><fo:inline font-weight="bold" >Predecessor Firm</fo:inline>;</fo:block>
				      <fo:block text-align="left" font-size="10px" start-indent="2.5cm" >(c)  the estate, heirs, executors, administrators, assigns and legal representatives of an <fo:inline font-weight="bold" >Insured</fo:inline> but only </fo:block>
				      <fo:block text-align="left" font-size="10px" start-indent="3cm" >in the  event of such <fo:inline font-weight="bold" >Insured's</fo:inline> death, incapacity, insolvency or bankruptcy, and only to the extent that</fo:block>
				      <fo:block text-align="left" font-size="10px" start-indent="3cm" > such <fo:inline font-weight="bold" > Insured</fo:inline> would otherwise have been provided coverage under the terms, conditions and exclusions of this policy;</fo:block>  
				      <fo:block text-align="left" font-size="10px" start-indent="2.5cm" >(d)  any contract or temporary employee of a <fo:inline font-weight="bold" >Named Insured</fo:inline> under the direct supervision of an <fo:inline font-weight="bold" > Insured</fo:inline>;</fo:block>  
				       ...
				       <fo:block text-align="left" font-size="10px" text-indent="1.5cm" >but only with respect to Professional Services performed within the scope of their duties on behalf of the </fo:block>
				        <fo:block text-align="left" font-size="10px" text-indent="1.5cm" ><fo:inline font-weight="bold" >Named Insured</fo:inline> or <fo:inline font-weight="bold" >Predecessor Firm</fo:inline>. </fo:block>
				        <fo:block margin-top="5mm"/> 
				         
				        <fo:block text-align="left" font-size="10px" >(3) Section IV.,  Definitions, definition of <fo:inline font-weight="bold" >Predecessor Firm</fo:inline> is deleted and replaced with the following definition:</fo:block> 
				         <fo:block margin-top="5mm"/> 
				         <fo:block text-align="left" font-size="10px" text-indent="1.5cm" ><fo:inline font-weight="bold" >Predecessor Firm</fo:inline> means an individual, partnership, professional corporation, professional association, limited </fo:block>
				         <fo:block text-align="left" font-size="10px" text-indent="1.5cm" >liability corporation or partnership which was at all times engaged in <fo:inline font-weight="bold" >Professional Services</fo:inline> and to whose </fo:block>
				         <fo:block text-align="left" font-size="10px" text-indent="1.5cm" >financial assets and liabilities the <fo:inline font-weight="bold" >Named Insured</fo:inline> became the majority successor in interest prior to the</fo:block>
				         ...
				         <fo:block text-align="left" font-size="10px" text-indent="1.5cm" >this policy. Predecessor Firm does not include any individual, partnership, professional corporation,</fo:block>
				          <fo:block text-align="left" font-size="10px" text-indent="1.5cm" >professional liability corporation or partnership which was at all times engaged in Professional Services and to</fo:block>
				           <fo:block text-align="left" font-size="10px" text-indent="1.5cm" >whose financial assets and  liabilities the <fo:inline font-weight="bold" >Named Insured</fo:inline> becomes the majority successor in interest</fo:block>
				           <fo:block text-align="left" font-size="10px" text-indent="1.5cm" >subsequent to the effective date of this  policy as stated in  Item 2. of the Declarations unless the <fo:inline font-weight="bold" > Insurer</fo:inline> at</fo:block>
				           <fo:block text-align="left" font-size="10px" text-indent="1.5cm" >its sole discretion agrees to include such entity.Should the <fo:inline font-weight="bold" >Insurer</fo:inline> agree to include such entity it may do so for</fo:block>
				          ...
				          <!-- 		     
				     <fo:block text-align="right" font-size="12px" ><fo:inline font-weight="bold" > Continued, on Page Two</fo:inline></fo:block>
				          -->	
				          <fo:table text-align="center">
				   ...
				   <fo:block text-align="left" font-size="10px" >(4) Section III., Paragraph D., Extended Reporting Period Extensions, sub- paragraph 3.<fo:inline font-weight="bold" >Retired  Insured </fo:inline> Extended </fo:block> 
				   ...
				   <fo:block text-align="left" font-size="10px" text-indent="1.5cm" >The additional premium charges stated herein shall be waived for a <fo:inline font-weight="bold" >Retired  Insured </fo:inline> who has been insured for</fo:block>
				    <fo:block text-align="left" font-size="10px" text-indent="1.5cm" >his/her <fo:inline font-weight="bold" >Professional Services </fo:inline> by the <fo:inline font-weight="bold" >Insurer </fo:inline> for three consecutive <fo:inline font-weight="bold" >Policy Periods </fo:inline>  prior to the date the </fo:block>
				    <fo:block text-align="left" font-size="10px" text-indent="1.5cm" ><fo:inline font-weight="bold" > Insured </fo:inline>becomes a <fo:inline font-weight="bold" >Retired  Insured </fo:inline>  and, such <fo:inline font-weight="bold" >Retired  Insured </fo:inline>:</fo:block>
				  
				       <fo:block margin-top="4mm"/>
				      <fo:block text-align="left" font-size="10px" start-indent="2.5cm" >(a) was, and is, the sole practitioner lawyer insured during said three consecutive <fo:inline font-weight="bold" >Policy Periods</fo:inline></fo:block> 
				      <fo:block text-align="left" font-size="10px" start-indent="2.9cm" > and;</fo:block>
				      <fo:block text-align="left" font-size="10px" start-indent="2.5cm" > (b) is the sole practitioner lawyers during the <fo:inline font-weight="bold" >Policy Periods </fo:inline>. stated in Item 2. of the Declarations.</fo:block> 
				          ...
				          <fo:block margin-top="4mm"/>
				       	 <fo:block text-align="left" font-size="10px" text-indent="1.5cm" >For the purpose of the applicability of this waiver of additional premium “sole practitioner lawyer” means </fo:block>
				       	  <fo:block text-align="left" font-size="10px" text-indent="1.5cm" >one who was engaged in performing <fo:inline font-weight="bold" >Professional Services </fo:inline> alone,  with no other partners, lawyers,</fo:block>
                   ...
                   <fo:block text-align="left" font-size="10px" text-indent="2cm" >any <fo:inline font-weight="bold" >Insured </fo:inline>. However, the <fo:inline font-weight="bold" >Insured</fo:inline> will provide the <fo:inline font-weight="bold" >Insured </fo:inline> with a defense of such Claim and pay </fo:block>
                   <fo:block text-align="left" font-size="10px" text-indent="2cm" ><fo:inline font-weight="bold" >Defense Expenses </fo:inline> for any such <fo:inline font-weight="bold" >Claim </fo:inline>until there is a judgment, final adjudication or adverse admission</fo:block>
                   <fo:block text-align="left" font-size="10px" text-indent="2cm" >by an <fo:inline font-weight="bold" >Insured </fo:inline>or a finding of  fact against an <fo:inline font-weight="bold" >Insured </fo:inline> as to such conduct. However, this exclusion shall not</fo:block>
                   <fo:block text-align="left" font-size="10px" text-indent="2cm" >apply to any <fo:inline font-weight="bold" >Insured </fo:inline> who, in fact, did not  personally commit, direct, participate in committing a dishonest,</fo:block>
