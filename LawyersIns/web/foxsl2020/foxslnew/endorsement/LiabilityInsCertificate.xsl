       ...
       <fo:static-content flow-name="xsl-region-before">
		...
		<fo:flow flow-name="xsl-region-body" >
          ...
          <fo:table>
			...
			<fo:block font-size="6px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">
			<fo:inline font-weight="bold">(A/C, No):</fo:inline>&#160; <fo:inline font-size="8px">630-799-1796</fo:inline>
			</fo:block>
			</fo:table-cell>
			</fo:table-row>
			<fo:table-row>
			...
			<fo:table-row>
             ...
             <fo:block font-size="6px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">
             <fo:inline font-weight="bold">INSURER A :</fo:inline>&#160; <fo:inline font-size="8px">United States Fire Insurance Company</fo:inline>
             </fo:block>
             </fo:table-cell>
             <fo:table-cell padding-top="1mm" padding-bottom="2mm" border="1pt solid" text-align="center">
             <fo:block font-size="6px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">
             <fo:inline font-weight="bold">21113</fo:inline>
             </fo:block>
             </fo:table-cell>
             </fo:table-row>
			</fo:table-body>
