...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/" name="Policycoverletter9">
								...
								<fo:table-row>
									...
									<fo:table-cell border="2pt solid black"	padding-bottom="4mm" padding-left="4pt">
									 <xsl:if test="response/policy_freeform_05/data/CompanyKey= 1">
										...
										<fo:block font-size="10px" text-align="left">Endorsement Number: ISMIE ALA-04-F011 (09/01/2021)</fo:block>
										</xsl:if>
		        ...
		        <xsl:if test="response/policy_freeform_05/data/CompanyKey= 3">
		         ...
		         <fo:block  font-size="10px" color="grey" text-align="left">ISMIE ALA-04-F011 (09/01/2021)
