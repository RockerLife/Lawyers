...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/" name="Policycoverletter36102">
							...
							<fo:table-body>
								<fo:table-row>
									...
									<fo:table-cell border="2pt solid black"	padding-bottom="4mm" padding-left="4pt">
										...
										<fo:block font-size="10px" text-align="left">Endorsement Number: ISMIE ALA-04-F018 (09/01/2021)</fo:block>
										</xsl:if>
					...
					<fo:block margin-top="2mm">
				     ...
				     <fo:block margin-top="10mm"/>
				      <xsl:if test="response/policy_freeform_05/data/CompanyKey= 1">
				     <fo:block text-align="left" font-size="10px" >it is agreed that Endorsement #LPL-102 (04/17) of this policy hereby deleted.</fo:block>
                    </xsl:if>
                     <xsl:if test="response/policy_freeform_05/data/CompanyKey= 3">
				     <fo:block text-align="left" font-size="10px" >it is agreed that Endorsement #ISMIE ALA-04-F018 (09/01/2021) of this policy hereby deleted.</fo:block>
                    </xsl:if>
	   ...
	   <xsl:if test="response/policy_freeform_05/data/CompanyKey= 3">
	        <fo:block  font-size="10px" color="grey" text-align="left">ISMIE ALA-04-F018 (09/01/2021)
