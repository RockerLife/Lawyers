...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/" name="LPL-AMEND-NM3">
	...
	<fo:block margin-top="3mm"></fo:block>
          ...
          <fo:block font-size="12px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" font-weight="bold" text-align="center" space-after="8mm">
            (DEFENSE EXPENSES WITHIN THE LIMIT AND FIRST DOLLAR DEFENSE)
          </fo:block>
          ...
          <fo:block>
            <fo:list-block provisional-distance-between-starts="0.8cm" provisional-label-separation="0.15cm">
                  ...
                  <fo:block>
                    <fo:list-block provisional-distance-between-starts="0.8cm" provisional-label-separation="0.15cm">
                      <fo:list-item>
                        ...
                        <fo:list-item-body >
                          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;"  font-weight="bold" text-align="justify">
                          &#160;
                          </fo:block>
                          <fo:block>
                            <fo:list-block provisional-distance-between-starts="0.8cm" provisional-label-separation="0.15cm">
                                    ...
                                    <fo:list-block provisional-distance-between-starts="0.8cm" provisional-label-separation="0.15cm">
                                      <fo:list-item>
                                        ...
                                        <fo:list-item-body start-indent="21mm">
                                          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="justify">
											Subject to 2. that follows, the <fo:inline font-weight="bold">Insurer’s</fo:inline> Limit of Liability for
											<fo:inline font-weight="bold">Damages</fo:inline> and <fo:inline font-weight="bold">Defense Expenses</fo:inline>, for each Claim first made and reported to
											the Insurer during the Policy Period, including any applicable Extended
											Reporting Period, shall not exceed the amount shown in Item 3. of the
											Declarations as applicable to “each <fo:inline font-weight="bold">Claim</fo:inline>”.
                                          </fo:block>
                                        </fo:list-item-body>
                                      </fo:list-item>
                                      ...
                                      <fo:list-item>
                                        ...
                                        <fo:list-item-body start-indent="21mm">
                                          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="justify">
										Subject to 1. above, the <fo:inline font-weight="bold">Insurer’s</fo:inline> Limit of Liability for <fo:inline font-weight="bold">Damages</fo:inline> and
										<fo:inline font-weight="bold">Defense Expenses</fo:inline>, for all <fo:inline font-weight="bold">Claims</fo:inline> first made and reported to the <fo:inline font-weight="bold">Insurer</fo:inline>
										during the <fo:inline font-weight="bold">Policy Period</fo:inline>, including any applicable Extended Reporting
										Period, shall not exceed the amount shown in Item 3. of the
										Declarations as applicable to “<fo:inline font-weight="bold">Policy Aggregate</fo:inline>”.
                                          </fo:block>
                                        </fo:list-item-body>
                                      </fo:list-item>
                                      ...
                                      <fo:list-item>
                                        ...
                                        <fo:list-item-body start-indent="21mm">
                                          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="justify">
										Subject to 1. and 2. above, <fo:inline font-weight="bold">Defense Expenses</fo:inline> charged against the Limit
										of Liability shall not exceed 50% of such Limit of Liability and the
										<fo:inline font-weight="bold">Insurer</fo:inline> shall assume any <fo:inline font-weight="bold">Defense Expenses</fo:inline> over that percentage.
                                          </fo:block>
                            ...
                            <fo:list-item>
                            <fo:list-item-label>
                            <fo:block start-indent="7mm" font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" >
                                    b.
                                  </fo:block>
                            </fo:list-item-label>
                                ...
                                <fo:list-item-body start-indent="21mm">
                                  ...
                                  <fo:block>
                                    <fo:list-block provisional-distance-between-starts="0.8cm" provisional-label-separation="0.15cm">
	                                  ...
	                                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" text-align="justify">
									The Deductible amount applies to the payment of <fo:inline font-weight="bold">Damages</fo:inline> only and shall
									not apply to <fo:inline font-weight="bold">Defense Expenses</fo:inline>. If the <fo:inline font-weight="bold">Insurer</fo:inline> advances any amounts
									...
									within 30 days of the <fo:inline font-weight="bold">Insurer’s</fo:inline> request to do so. In the event of
									<fo:inline font-weight="bold">Related Claims</fo:inline>, a single Deductible amount will apply.
              ...
              <fo:list-item-body>
             <fo:block start-indent="14mm" font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" text-align="justify">
           				The following subsection is added:  </fo:block>
              <fo:block>
               <fo:list-block>
               <fo:list-item>
               <fo:list-item-label>
               <fo:block start-indent="14mm">
               <fo:inline font-size="10px" font-weight="bold" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">&#8226;</fo:inline>
               </fo:block>
               </fo:list-item-label>
               <fo:list-item-body>
               <fo:block start-indent="21mm" space-after="3mm">
               <fo:inline  font-size="10px" font-weight="bold" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;">Accounting</fo:inline>
               </fo:block>
                 <fo:block start-indent="21mm" font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" text-align="justify">
					Where the Limit of Liability of the policy is reduced by <fo:inline font-weight="bold">Defense
					Expenses</fo:inline>, the <fo:inline font-weight="bold">Insurer</fo:inline> shall notify the <fo:inline font-weight="bold">Named Insured</fo:inline> of its right, upon
					written request, to an accounting of <fo:inline font-weight="bold">Defense Expenses</fo:inline> actually
					expended.
                 </fo:block>
               </fo:list-item-body>
               </fo:list-item>
                ...
                <fo:list-item-body start-indent="7mm">
                  <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="4mm" text-align="justify">
                    ...
                    <fo:list-block provisional-distance-between-starts="0.8cm" provisional-label-separation="0.15cm">
                      <fo:list-item>
                        <fo:list-item-label start-indent="7mm">
                          <fo:block font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" font-weight="bold">M.</fo:block>
                        </fo:list-item-label>
                        <fo:list-item-body >
                          <fo:block start-indent="14mm" font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" space-after="2mm" text-align="justify">
                          ...
                          <fo:list-item>
                            ...
                            <fo:list-item-body start-indent="21mm">
                             ...
                             <fo:block start-indent="14mm" font-size="10px" font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" text-align="justify">
              ...
              <fo:list-item>
				<fo:list-item-label>
				  ...
				  <fo:list-item-body>
				   <fo:block  font-size="10px" color="grey" text-align="left">LPL-AMEND-NM3 (04/19)
