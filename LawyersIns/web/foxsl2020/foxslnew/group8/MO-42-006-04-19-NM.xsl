...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/" name="NM-DWL-Notice006">
		...
		<fo:block text-align="left" start-indent="1cm" space-after="1.5cm" >				  	
					...
					<fo:block font-family="Arial, 'Helvetica Neue', Helvetica, sans-serif;" font-weight="bold" text-align="center"
						font-size="14px" space-after="6mm">(DEFENSE EXPENSES WITHIN THE LIMIT AND FIRST DOLLAR DEFENSE)
					...
					<fo:table>
						...
						font-size="11px" space-after="15mm">
							The limits of liability contained in the policy shall be reduced up to 50% by legal defense costs and, in such event, the insurer shall be liable for legal defense costs exceeding that percentage.
						</fo:block>
					...
					*MUST BE SIGNED BY A DULY AUTHORIZED OFFICER OF THE <fo:inline font-weight="bold">NAMED INSURED</fo:inline> ON BEHALF OF ALL <fo:inline font-weight="bold">INSUREDS</fo:inline>.
					...
					<fo:block margin-top="10cm" />
					 <fo:block  start-indent="1cm" font-size="10px" color="grey" text-align="left">MO 42 006 04 19</fo:block>
