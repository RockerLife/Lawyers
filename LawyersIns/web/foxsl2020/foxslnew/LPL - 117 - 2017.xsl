...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/" name="Policycoverletter17">
					<fo:block>				  	
    ...
    <fo:leader leader-pattern="rule" />
				     ...
				     <fo:block text-align="center" font-weight="bold" font-size="10px"  >DOES NOT APPLIES TO DEFENSE EXPENSES</fo:block>
				     <fo:block margin-top="8mm"/>
				     ...
				     <fo:table border="2pt solid black">
				      ...
				      <fo:block text-align="left" font-size="10px" start-indent="0.5cm">1. The <fo:inline font-weight="bold" >Insurer</fo:inline> shall have the right and the duty to defend any <fo:inline font-weight="bold" >Claim</fo:inline> regardless of whether the allegations are </fo:block>
				         ...
				         <fo:block text-align="left" font-size="10px" start-indent="1cm">groundless, false or fraudulant. In undertaking this right and duty, the <fo:inline font-weight="bold" >Insurer</fo:inline> expressly retains the right to select </fo:block>
				         <fo:block text-align="left" font-size="10px" start-indent="0.5cm">defense counsel even when the <fo:inline font-weight="bold" >Insurer</fo:inline> reserve its right on issues concerning the applicability of coverage under this policy. The <fo:inline font-weight="bold" >Insurer's</fo:inline> right and duty to defend any <fo:inline font-weight="bold" >Claim</fo:inline> and pay <fo:inline font-weight="bold" >Defense Expenses</fo:inline> shall terminate upon the </fo:block>
