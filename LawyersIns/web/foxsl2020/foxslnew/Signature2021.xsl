...
<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/" name="Signature2021">
					...
					<fo:table border="0" text-align="center">
						...
						<fo:table-body>
							...
							<fo:table-row>
								...
								<fo:table-cell border="0" padding-left="4pt">
									<fo:block text-align="center">
										<fo:external-graphic height=".90in"  content-width="1.5in"  src="../LawyersIns/image/sign3.png" />
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row>
								...
								<fo:table-cell border="0" padding-left="4pt">
									<fo:block font-size="10px" text-align="center">Michael P. McTigue
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row>
