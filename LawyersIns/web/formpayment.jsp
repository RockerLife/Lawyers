...
<BODY>
    ...
    <form name ="test" action="formpayment.do;jsessionid=<%= request.getParameter("jsessionid") %>" method="post">
    <input type="hidden" name="inet_method" value="formshowpayment"/>
    <input type="hidden" name="inet_page" value="formshowpayment"/>
